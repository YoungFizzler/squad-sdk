...
void IBPI_HUD_C::Open_Deployment()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Open Deployment");
...
void IBPI_HUD_C::Create_Radial_Menu(class UClass* Model, class FName Close_Command, class UObject* Context)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Create Radial Menu");
...
void IBPI_HUD_C::Get_Radial_Menu(class UBaseRadialMenu_C** Radial_Menu)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Radial Menu");
...
void IBPI_HUD_C::Show_3D_Marker(class ASQMapMarker* Marker)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Show 3D Marker");
...
void IBPI_HUD_C::Get_Main_Menus(class UUMG_MenuBase_C** Deployment, class UUMG_MenuBase_C** Command, class UUMG_MenuBase_C** Roaming)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Main Menus");
...
void IBPI_HUD_C::Show_End_Scoreboard()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Show End Scoreboard");
...
void IBPI_HUD_C::Get_Is_Showing_Settings_Menu(bool* Showing_Main_Menu)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Is Showing Settings Menu");
...
void IBPI_HUD_C::Get_Map_Core(class UW_SQMapCore_C** Map_Core)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Map Core");
...
void IBPI_HUD_C::Get_Map_Component(class USQCoreStateMapComponent** Map_Component)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Map Component");
...
void IBPI_HUD_C::Menu_Toggle(bool Instant, class UUMG_MenuBase_C* In_Menu, bool Show_Mouse)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Menu Toggle");
...
void IBPI_HUD_C::Clear_All_Floating_Widgets()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Clear All Floating Widgets");
...
void IBPI_HUD_C::Toggle_Main_Menu()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Toggle Main Menu");
...
void IBPI_HUD_C::Menu_Close(class UUMG_MenuBase_C* Menu)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Menu Close");
...
void IBPI_HUD_C::End_Match()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "End Match");
...
void IBPI_HUD_C::Create_SL_Menu()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Create SL Menu");
...
void IBPI_HUD_C::Destroy_SL_Menu()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Destroy SL Menu");
...
void IBPI_HUD_C::Close_Radial()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Close Radial");
...
void IBPI_HUD_C::Show_Leaderboard(bool Show)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Show Leaderboard");
...
void IBPI_HUD_C::Toggle_Leaderboard()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Toggle Leaderboard");
...
void IBPI_HUD_C::Get_Scoreboard(class USQScoreboard** ScoreBoard)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Scoreboard");
...
void IBPI_HUD_C::Set_Commander_Max_Cooldowns()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Set Commander Max Cooldowns");
...
void IBPI_HUD_C::Player_Died()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Player Died");
...
void IBPI_HUD_C::Get_UI_Input_Stacks(TArray<struct FSQInputState>* Input_Stacks)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get UI Input Stacks");
...
void IBPI_HUD_C::Get_Interactable_Widget(class USQInteractableWidgetList** Interact_Widget)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Interactable Widget");
...
void IBPI_HUD_C::Close_Menus()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Close Menus");
...
void IBPI_HUD_C::Destroy_Radial()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Destroy Radial");
...
void IBPI_HUD_C::Zoom_In_Map()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Zoom In Map");
...
void IBPI_HUD_C::Get_Showing_Main_Menu(bool* Showing)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Get Showing Main Menu");
...
void IBPI_HUD_C::Zoom_In_Map_Wheel(float Axis)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Zoom In Map Wheel");
...
void IBPI_HUD_C::Start_Match()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "Start Match");
...
void IBPI_HUD_C::CreateEmoteWheel()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "CreateEmoteWheel");
...
void IBPI_HUD_C::DestroyEmoteWheel()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_HUD_C", "DestroyEmoteWheel");
