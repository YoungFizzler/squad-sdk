...
public:
	...
	void BndEvt__GraphicsWindowXeSS_XESSQUALITY_K2Node_ComponentBoundEvent_19_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__GraphicsWindow_REFLEXMODE_K2Node_ComponentBoundEvent_29_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__GraphicsWindow_FGMODES_K2Node_ComponentBoundEvent_25_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void OnInitialized();
	void BndEvt__GraphicsWindow_DLSSSHARPNESS_K2Node_ComponentBoundEvent_26_OnValueChanged__DelegateSignature(float Value);
	void BndEvt__GraphicsWindow_SAMPLINGOPTION_K2Node_ComponentBoundEvent_24_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	...
	void BndEvt__GraphicsWindow_DLSSMODES_K2Node_ComponentBoundEvent_19_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	...
	void BndEvt__GraphicsWindow_SCOPEUPDATERATE_K2Node_ComponentBoundEvent_20_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	...
	void Construct();
	void BndEvt__GraphicsWindow_D3DSetting_K2Node_ComponentBoundEvent_3_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	...
	void BndEvt__GraphicsWindow_Merge_FSR2MODE_K2Node_ComponentBoundEvent_5_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	...
	void APPLY_SETTINGS();
	void BENCHMARK();
	void BndEvt__RESCOMBO_K2Node_ComponentBoundEvent_0_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
