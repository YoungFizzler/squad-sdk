...
static_assert(offsetof(W_ModTooltip_C_Is_Whitelisted, Is_Whitelisted_0) == 0x000000, "Member 'W_ModTooltip_C_Is_Whitelisted::Is_Whitelisted_0' has a wrong offset!");
