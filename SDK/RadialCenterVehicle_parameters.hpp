...
public:
	...
	bool                                          CallFunc_GetActionKeyName_ReturnValue;             // 0x007C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(RadialCenterVehicle_C_ExecuteUbergraph_RadialCenterVehicle, CallFunc_GetActionKeyName_ReturnValue) == 0x00007C, "Member 'RadialCenterVehicle_C_ExecuteUbergraph_RadialCenterVehicle::CallFunc_GetActionKeyName_ReturnValue' has a wrong offset!");
