...
public:
	...
	TMulticastInlineDelegate<void(bool bSelected, class UMainMenu_Button_C* Button)> OnClicked;      // 0x02F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(bool bHovered)> OnHover;                                           // 0x0338(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	struct FMargin                                IconMargin;                                        // 0x0358(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	float                                         Icon_Size_Y;                                       // 0x0368(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Icon_Size_X;                                       // 0x036C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Icon_Angle;                                        // 0x0370(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	uint8                                         Pad_374[0x4];                                      // 0x0374(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FSlateColor                            Icon_Color;                                        // 0x0378(0x0028)(Edit, BlueprintVisible)
	class FText                                   Display_Text;                                      // 0x03A0(0x0018)(Edit, BlueprintVisible)
	int32                                         Text_Size;                                         // 0x03B8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FMargin                                Text_Padding_Amount;                               // 0x03BC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FMargin                                Button_Padding;                                    // 0x03CC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FLinearColor                           Text_Normal;                                       // 0x03DC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Text_Toggle_Normal;                                // 0x03EC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Text_Selected;                                     // 0x03FC(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Text_Hovered;                                      // 0x040C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Text_Selected_Hovered;                             // 0x041C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Line_Color;                                        // 0x042C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Line_Hover_Color;                                  // 0x043C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FLinearColor                           Line_Unhover_Color;                                // 0x044C(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_45C[0x4];                                      // 0x045C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMulticastInlineDelegate<void()>              OnDoubleClicked;                                   // 0x0460(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	float                                         Last_Click_Time;                                   // 0x0470(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          bNewContent;                                       // 0x0474(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
	bool                                          bDisabled;                                         // 0x0475(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn)
...
static_assert(sizeof(UMainMenu_Button_C) == 0x000478, "Wrong size on UMainMenu_Button_C");
...
static_assert(offsetof(UMainMenu_Button_C, IconMargin) == 0x000358, "Member 'UMainMenu_Button_C::IconMargin' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Icon_Size_Y) == 0x000368, "Member 'UMainMenu_Button_C::Icon_Size_Y' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Icon_Size_X) == 0x00036C, "Member 'UMainMenu_Button_C::Icon_Size_X' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Icon_Angle) == 0x000370, "Member 'UMainMenu_Button_C::Icon_Angle' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Icon_Color) == 0x000378, "Member 'UMainMenu_Button_C::Icon_Color' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Display_Text) == 0x0003A0, "Member 'UMainMenu_Button_C::Display_Text' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Size) == 0x0003B8, "Member 'UMainMenu_Button_C::Text_Size' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Padding_Amount) == 0x0003BC, "Member 'UMainMenu_Button_C::Text_Padding_Amount' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Button_Padding) == 0x0003CC, "Member 'UMainMenu_Button_C::Button_Padding' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Normal) == 0x0003DC, "Member 'UMainMenu_Button_C::Text_Normal' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Toggle_Normal) == 0x0003EC, "Member 'UMainMenu_Button_C::Text_Toggle_Normal' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Selected) == 0x0003FC, "Member 'UMainMenu_Button_C::Text_Selected' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Hovered) == 0x00040C, "Member 'UMainMenu_Button_C::Text_Hovered' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Text_Selected_Hovered) == 0x00041C, "Member 'UMainMenu_Button_C::Text_Selected_Hovered' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Line_Color) == 0x00042C, "Member 'UMainMenu_Button_C::Line_Color' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Line_Hover_Color) == 0x00043C, "Member 'UMainMenu_Button_C::Line_Hover_Color' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Line_Unhover_Color) == 0x00044C, "Member 'UMainMenu_Button_C::Line_Unhover_Color' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, OnDoubleClicked) == 0x000460, "Member 'UMainMenu_Button_C::OnDoubleClicked' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, Last_Click_Time) == 0x000470, "Member 'UMainMenu_Button_C::Last_Click_Time' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, bNewContent) == 0x000474, "Member 'UMainMenu_Button_C::bNewContent' has a wrong offset!");
static_assert(offsetof(UMainMenu_Button_C, bDisabled) == 0x000475, "Member 'UMainMenu_Button_C::bDisabled' has a wrong offset!");
