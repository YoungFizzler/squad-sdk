...
public:
	...
	TMulticastInlineDelegate<void(const struct FPointerEvent& Mouse_Event, const struct FVector& World_Location)> Mouse_Down; // 0x03C8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnUpdateZoom;                                      // 0x0460(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void PerformZoom(float TargetZoom_0, const struct FVector2D& ZoomPosition, class UUserWidget* RootLayer, class UPanelWidget* ZoomLayer, class UPanelWidget* PanLayer);
	...
	void Setup(class USQCoreStateMapComponent* MapComponent_0);
	...
	void AdjustHorizontalBarPadding(float TargetZoom_0);
	void AdjustVerticalBarPadding(float TargetZoom_0);
