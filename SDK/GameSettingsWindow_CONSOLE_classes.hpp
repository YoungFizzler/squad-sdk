...
public:
	...
	class USettingsItem_TickBox_C*                ToggleDouble_TapWalk;                              // 0x0328(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	TMulticastInlineDelegate<void()>              Reset_Appdata_OnClicked;                           // 0x0398(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void BndEvt__SprintMode_K2Node_ComponentBoundEvent_14_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__LeanMode_K2Node_ComponentBoundEvent_12_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__FreelookMode_K2Node_ComponentBoundEvent_11_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__ADSMode_K2Node_ComponentBoundEvent_9_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__CrouchMode_K2Node_ComponentBoundEvent_5_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
...
static_assert(offsetof(UGameSettingsWindow_CONSOLE_C, ToggleDouble_TapWalk) == 0x000328, "Member 'UGameSettingsWindow_CONSOLE_C::ToggleDouble_TapWalk' has a wrong offset!");
