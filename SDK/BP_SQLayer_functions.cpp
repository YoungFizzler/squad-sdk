...
// class UBP_SQLevel_C**                   OuterLevel_0                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_SQLayer_C::GetOuterLevel(bool* Out_Success, class UBP_SQLevel_C** OuterLevel_0)
{
	...
	if (OuterLevel_0 != nullptr)
		*OuterLevel_0 = Parms.OuterLevel_0;
}
...
// (Event, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent, BlueprintPure, Const)
// Parameters:
// const int32                             InTeam                                                 (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// const class USQAvailability*            InAvailability                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
