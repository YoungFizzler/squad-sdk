...
public:
	...
	int32                                         LastTicketChange;                                  // 0x00DC(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UGraphTicketComponent_C, LastTicketChange) == 0x0000DC, "Member 'UGraphTicketComponent_C::LastTicketChange' has a wrong offset!");
