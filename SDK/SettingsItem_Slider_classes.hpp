...
public:
	...
	TMulticastInlineDelegate<void(float Value)>   OnValueChanged;                                    // 0x0348(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(float Value)>   OnCaptureEnd;                                      // 0x0390(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void SetSettingValue(class FName Setting_Name, const class FString& Value_0);
	void BndEvt__Slider_K2Node_ComponentBoundEvent_361_OnFloatValueChangedEvent__DelegateSignature(float Value_0);
	...
	void GetTextColor(float Value_0, struct FLinearColor* TextColor, class FText* WarningText);
	void UpdateTextStyle(float Value_0);
