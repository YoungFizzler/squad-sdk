...
// const struct FLinearColor&              CustomIconColor                                        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// Function W_NotificationPanel.W_NotificationPanel_C.SwitchToEndScreen
// (Public, BlueprintCallable, BlueprintEvent)

void UW_NotificationPanel_C::SwitchToEndScreen()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("W_NotificationPanel_C", "SwitchToEndScreen");
