...
public:
	...
	TDelegate<void(const struct FHitResult& HitResult, float TimeSlice, const struct FVector& MoveDelta)> K2Node_CreateDelegate_OutputDelegate_7; // 0x091C(0x0010)(ZeroConstructor, NoDestructor)
