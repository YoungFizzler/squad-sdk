...
{
public:
	bool                                          Is_Self_Team_0;                                    // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         My_Seat_ID_0;                                      // 0x0004(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(W_Tooltip_Vehicle_C_Update_All_Seats, Is_Self_Team_0) == 0x000000, "Member 'W_Tooltip_Vehicle_C_Update_All_Seats::Is_Self_Team_0' has a wrong offset!");
static_assert(offsetof(W_Tooltip_Vehicle_C_Update_All_Seats, My_Seat_ID_0) == 0x000004, "Member 'W_Tooltip_Vehicle_C_Update_All_Seats::My_Seat_ID_0' has a wrong offset!");
...
static_assert(offsetof(W_Tooltip_Vehicle_C_Update_Seat_ID, Index_0) == 0x000000, "Member 'W_Tooltip_Vehicle_C_Update_Seat_ID::Index_0' has a wrong offset!");
