...
void IBPI_Helicopter_C::Is_Using_Landing_Camera(bool* Using_Landing_Camera)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Helicopter_C", "Is Using Landing Camera");
...
void IBPI_Helicopter_C::Get_UI_Tint(struct FLinearColor* Color)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Helicopter_C", "Get UI Tint");
...
void IBPI_Helicopter_C::Set_Landing_Camera(bool Active)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Helicopter_C", "Set Landing Camera");
