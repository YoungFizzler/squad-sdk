...
public:
	...
	TMulticastInlineDelegate<void(class USQSessionInfo* Session)> RequestJoin;                       // 0x03B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class UObject*                                Friend_List;                                       // 0x0440(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void Is_Whitelisted(bool* Is_Whitelisted_0);
	bool Is_Modded();
