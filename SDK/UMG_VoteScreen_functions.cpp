...
// const struct FSQChoice&                 Winner                                                 (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
void UUMG_VoteScreen_C::SwitchToScreen(int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// const struct FSQLayerSettings&          LayerInfo                                              (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
void UUMG_VoteScreen_C::UpdatePlayersCountText(int32 Index_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// class UTextBlock*                       TextTop_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class UTextBlock*                       TextTimer_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUMG_VoteScreen_C::SetOuterTimer(class UTextBlock* TextTop_0, class UTextBlock* TextTimer_0)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UMG_VoteScreen_C", "SetOuterTimer");

	Params::UMG_VoteScreen_C_SetOuterTimer Parms{};

	Parms.TextTop_0 = TextTop_0;
	Parms.TextTimer_0 = TextTimer_0;
