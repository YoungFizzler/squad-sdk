...
// Parameters:
// const TArray<class ASQEquipableItem*>&  In_Array                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
// const TArray<struct FSQInventoryData>&  Data_Array_0                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UW_BackpackRow_C::Set_Items(const TArray<class ASQEquipableItem*>& In_Array, const TArray<struct FSQInventoryData>& Data_Array_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Data_Array_0 = std::move(Data_Array_0);
