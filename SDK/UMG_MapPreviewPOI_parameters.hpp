...
static_assert(offsetof(UMG_MapPreviewPOI_C_GetPOIElement, Index_0) == 0x000000, "Member 'UMG_MapPreviewPOI_C_GetPOIElement::Index_0' has a wrong offset!");
...
static_assert(offsetof(UMG_MapPreviewPOI_C_GetOrderID, Index_0) == 0x000008, "Member 'UMG_MapPreviewPOI_C_GetOrderID::Index_0' has a wrong offset!");
