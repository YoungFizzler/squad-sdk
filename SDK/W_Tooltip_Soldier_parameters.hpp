...
{
public:
	struct FSQSoldierInfo                         Soldier_Info_0;                                    // 0x0000(0x0028)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(offsetof(W_Tooltip_Soldier_C_Update_Info, Soldier_Info_0) == 0x000000, "Member 'W_Tooltip_Soldier_C_Update_Info::Soldier_Info_0' has a wrong offset!");
