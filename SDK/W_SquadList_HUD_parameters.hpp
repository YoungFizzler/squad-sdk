...
{
public:
	bool                                          bIsOpen_0;                                         // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(W_SquadList_HUD_C_ToggleOpen, bIsOpen_0) == 0x000000, "Member 'W_SquadList_HUD_C_ToggleOpen::bIsOpen_0' has a wrong offset!");
