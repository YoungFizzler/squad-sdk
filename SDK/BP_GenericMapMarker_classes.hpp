...
public:
	...
	struct FLinearColor                           DefaultTint;                                       // 0x0280(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(ABP_GenericMapMarker_C) == 0x000290, "Wrong size on ABP_GenericMapMarker_C");
static_assert(offsetof(ABP_GenericMapMarker_C, UberGraphFrame) == 0x000270, "Member 'ABP_GenericMapMarker_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_GenericMapMarker_C, DefaultSceneRoot) == 0x000278, "Member 'ABP_GenericMapMarker_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_GenericMapMarker_C, DefaultTint) == 0x000280, "Member 'ABP_GenericMapMarker_C::DefaultTint' has a wrong offset!");
