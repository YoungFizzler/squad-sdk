...
public:
	...
	class APlayerState*                           RequestMarkerOwner;                                // 0x0308(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UW_CommandActionCategory_C) == 0x000310, "Wrong size on UW_CommandActionCategory_C");
...
static_assert(offsetof(UW_CommandActionCategory_C, RequestMarkerOwner) == 0x000308, "Member 'UW_CommandActionCategory_C::RequestMarkerOwner' has a wrong offset!");
