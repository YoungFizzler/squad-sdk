...
public:
	...
	TMulticastInlineDelegate<void()>              CloseTooltip;                                      // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void IsSelf(bool* IsSelf_0) const;
	void IsSelfCameraMan(bool* IsSelfCameraMan_0) const;
	void IsSameTeam(bool* IsSameTeam_0) const;
