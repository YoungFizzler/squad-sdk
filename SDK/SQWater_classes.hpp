...
{
public:
	TMulticastInlineDelegate<void()>              OnEnteredWaterBodyDelegate;                        // 0x00B0(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void()>              OnExitedWaterBodyDelegate;                         // 0x00C0(0x0010)(ZeroConstructor, Transient, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(const struct FODKSphericalPontoon& Pontoon)> OnPontoonEnteredWaterDelegate; // 0x0198(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FODKSphericalPontoon& Pontoon)> OnPontoonExitedWaterDelegate; // 0x01A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	TMulticastInlineDelegate<void(bool bIsImmersed)> OnImmersionStateChanged;                        // 0x00B8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	void SetBuoyancyComponent(class USQBuoyancyComponent* BuoyancyComponent_0);
...
// 0x0068 (0x0118 - 0x00B0)
class UODKWaterIntensityDrawComponent final : public UActorComponent
{
public:
...
class ASQLake final : public ASQWaterBody
{
public:
...
class ASQOcean final : public ASQWaterBody
{
public:
