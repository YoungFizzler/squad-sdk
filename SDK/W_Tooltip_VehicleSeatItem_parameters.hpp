...
{
public:
	struct FSQVehicleOccupantInfo                 Occupant_Info_0;                                   // 0x0000(0x0038)(BlueprintVisible, BlueprintReadOnly, Parm)
	class USQMapWidgetVehicle*                    Vehicle_Widget_0;                                  // 0x0038(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Is_Self_Team_0;                                    // 0x0040(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_41[0x3];                                       // 0x0041(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         My_Seat_ID_0;                                      // 0x0044(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         Seat_Index_0;                                      // 0x0048(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(W_Tooltip_VehicleSeatItem_C_Update_Occupant, Occupant_Info_0) == 0x000000, "Member 'W_Tooltip_VehicleSeatItem_C_Update_Occupant::Occupant_Info_0' has a wrong offset!");
static_assert(offsetof(W_Tooltip_VehicleSeatItem_C_Update_Occupant, Vehicle_Widget_0) == 0x000038, "Member 'W_Tooltip_VehicleSeatItem_C_Update_Occupant::Vehicle_Widget_0' has a wrong offset!");
static_assert(offsetof(W_Tooltip_VehicleSeatItem_C_Update_Occupant, Is_Self_Team_0) == 0x000040, "Member 'W_Tooltip_VehicleSeatItem_C_Update_Occupant::Is_Self_Team_0' has a wrong offset!");
static_assert(offsetof(W_Tooltip_VehicleSeatItem_C_Update_Occupant, My_Seat_ID_0) == 0x000044, "Member 'W_Tooltip_VehicleSeatItem_C_Update_Occupant::My_Seat_ID_0' has a wrong offset!");
static_assert(offsetof(W_Tooltip_VehicleSeatItem_C_Update_Occupant, Seat_Index_0) == 0x000048, "Member 'W_Tooltip_VehicleSeatItem_C_Update_Occupant::Seat_Index_0' has a wrong offset!");
