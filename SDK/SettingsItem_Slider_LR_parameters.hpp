...
static_assert(offsetof(SettingsItem_Slider_LR_C_SetValue, Value_0) == 0x000000, "Member 'SettingsItem_Slider_LR_C_SetValue::Value_0' has a wrong offset!");
