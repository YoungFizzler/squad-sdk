...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class URadialCenterRearmButton_C*       CenterWidget_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void URadialRearmWidget_C::SetCenterWidget(class URadialCenterRearmButton_C* CenterWidget_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CenterWidget_0 = CenterWidget_0;
