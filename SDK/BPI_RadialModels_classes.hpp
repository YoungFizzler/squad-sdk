...
class IBPI_RadialModels_C final
{
public:
...
static_assert(alignof(IBPI_RadialModels_C) == 0x000001, "Wrong alignment on IBPI_RadialModels_C");
static_assert(sizeof(IBPI_RadialModels_C) == 0x000001, "Wrong size on IBPI_RadialModels_C");
