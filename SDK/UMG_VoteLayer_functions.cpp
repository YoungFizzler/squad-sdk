...
// Parameters:
// const class FText&                      TeamName                                               (BlueprintVisible, BlueprintReadOnly, Parm)
// class FName                             PlayerName_0                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UUMG_VoteLayer_C::OnSetup(const class FText& TeamName, class FName PlayerName_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.PlayerName_0 = PlayerName_0;
...
// const struct FSQChoice&                 SQChoice                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, NoDestructor)
