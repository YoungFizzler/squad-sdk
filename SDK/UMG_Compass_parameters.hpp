...
public:
	...
	TDelegate<void(const class USQGameUserSettings* UserSettings)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0030(0x0010)(ZeroConstructor, NoDestructor)
...
{
public:
	bool                                          bTopScreenView_0;                                  // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(UMG_Compass_C_ChangeDisplayMode, bTopScreenView_0) == 0x000000, "Member 'UMG_Compass_C_ChangeDisplayMode::bTopScreenView_0' has a wrong offset!");
