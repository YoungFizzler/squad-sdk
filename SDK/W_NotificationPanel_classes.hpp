...
public:
	...
	struct FVector2D                              ViewportOffset;                                    // 0x0290(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FVector2D                              EndScreenOffset;                                   // 0x0298(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UW_NotificationPanel_C) == 0x0002A0, "Wrong size on UW_NotificationPanel_C");
...
static_assert(offsetof(UW_NotificationPanel_C, ViewportOffset) == 0x000290, "Member 'UW_NotificationPanel_C::ViewportOffset' has a wrong offset!");
static_assert(offsetof(UW_NotificationPanel_C, EndScreenOffset) == 0x000298, "Member 'UW_NotificationPanel_C::EndScreenOffset' has a wrong offset!");
