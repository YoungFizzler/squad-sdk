...
public:
	...
	TMulticastInlineDelegate<void(bool bIsAscending, E_SortType Sort_Type)> OnClicked;               // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(bool bHovered)> OnHover;                                           // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void Construct();
	void Set_Selected(bool bSelected_0);
	void Update_Widget();
	void Set_Text(const class FText& Text);
	ESlateVisibility Set_Arrow();
	void Set_Sort_State(ESQSortStates SortState_0, bool bSelected_0);
