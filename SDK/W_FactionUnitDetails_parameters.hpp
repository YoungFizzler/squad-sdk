...
static_assert(offsetof(W_FactionUnitDetails_C_FillFromFaction, TeamId_0) == 0x000010, "Member 'W_FactionUnitDetails_C_FillFromFaction::TeamId_0' has a wrong offset!");
...
static_assert(offsetof(W_FactionUnitDetails_C_GetChoiceIndex, Index_0) == 0x000008, "Member 'W_FactionUnitDetails_C_GetChoiceIndex::Index_0' has a wrong offset!");
...
static_assert(offsetof(W_FactionUnitDetails_C_GetFactionSetup, Index_0) == 0x000000, "Member 'W_FactionUnitDetails_C_GetFactionSetup::Index_0' has a wrong offset!");
...
public:
	class USQFactionSetup*                        Faction;                                           // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                   TargetCategory;                                    // 0x0008(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         RowCount;                                          // 0x0010(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class USQAvailability_Vehicle*                CallFunc_Array_Get_Item;                           // 0x0030(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UBP_SQVehicleSettings_C*                K2Node_DynamicCast_AsBP_SQVehicle_Settings;        // 0x0038(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_Ruleset_Vehicle_C*                  K2Node_DynamicCast_AsBP_Ruleset_Vehicle;           // 0x0060(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_DynamicCast_bSuccess_1;                     // 0x0068(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_69[0x7];                                       // 0x0069(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMG_VehicleTableItem_C*                CallFunc_GetVehicleRow_Row;                        // 0x0070(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_GetVehicleRow_Valid;                      // 0x0078(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class UUMG_VehicleTableList_C*                CallFunc_Map_Find_Value;                           // 0x0080(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class UUMG_VehicleTableList_C*                K2Node_Select_Default;                             // 0x0098(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	TArray<class UUMG_VehicleTableList_C*>        CallFunc_Map_Values_Values;                        // 0x00A0(0x0010)(ReferenceParm, ContainsInstancedReference)
	class FName                                   CallFunc_Map_Find_Value_1;                         // 0x00B0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Map_Find_ReturnValue_1;                   // 0x00B8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_B9[0x7];                                       // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UUMG_VehicleTableList_C*                CallFunc_Array_Get_Item_1;                         // 0x00C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FName                                   K2Node_Select_Default_1;                           // 0x00C8(0x0008)(ConstParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, TargetCategory) == 0x000008, "Member 'W_FactionUnitDetails_C_FillVehicles::TargetCategory' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, RowCount) == 0x000010, "Member 'W_FactionUnitDetails_C_FillVehicles::RowCount' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_int_Loop_Counter_Variable) == 0x000014, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Add_IntInt_ReturnValue) == 0x000018, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Array_Length_ReturnValue) == 0x00001C, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Less_IntInt_ReturnValue) == 0x000020, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_int_Array_Index_Variable) == 0x000024, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_int_Variable) == 0x000028, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_int_Variable' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Array_Get_Item) == 0x000030, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, K2Node_DynamicCast_AsBP_SQVehicle_Settings) == 0x000038, "Member 'W_FactionUnitDetails_C_FillVehicles::K2Node_DynamicCast_AsBP_SQVehicle_Settings' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, K2Node_DynamicCast_bSuccess) == 0x000040, "Member 'W_FactionUnitDetails_C_FillVehicles::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000041, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_MakeLiteralName_ReturnValue) == 0x000044, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_MakeLiteralName_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_bool_Variable) == 0x00004C, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_int_Array_Index_Variable_1) == 0x000050, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_int_Array_Index_Variable_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_GetDefaultObjectFor_ReturnValue) == 0x000058, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_GetDefaultObjectFor_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, K2Node_DynamicCast_AsBP_Ruleset_Vehicle) == 0x000060, "Member 'W_FactionUnitDetails_C_FillVehicles::K2Node_DynamicCast_AsBP_Ruleset_Vehicle' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, K2Node_DynamicCast_bSuccess_1) == 0x000068, "Member 'W_FactionUnitDetails_C_FillVehicles::K2Node_DynamicCast_bSuccess_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_GetVehicleRow_Row) == 0x000070, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_GetVehicleRow_Row' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_GetVehicleRow_Valid) == 0x000078, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_GetVehicleRow_Valid' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Add_IntInt_ReturnValue_1) == 0x00007C, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Map_Find_Value) == 0x000080, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Map_Find_Value' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Map_Find_ReturnValue) == 0x000088, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Map_Find_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_int_Loop_Counter_Variable_1) == 0x00008C, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_int_Loop_Counter_Variable_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, Temp_bool_Variable_1) == 0x000090, "Member 'W_FactionUnitDetails_C_FillVehicles::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Add_IntInt_ReturnValue_2) == 0x000094, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Add_IntInt_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, K2Node_Select_Default) == 0x000098, "Member 'W_FactionUnitDetails_C_FillVehicles::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Map_Values_Values) == 0x0000A0, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Map_Values_Values' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Map_Find_Value_1) == 0x0000B0, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Map_Find_Value_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Map_Find_ReturnValue_1) == 0x0000B8, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Map_Find_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Array_Get_Item_1) == 0x0000C0, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, K2Node_Select_Default_1) == 0x0000C8, "Member 'W_FactionUnitDetails_C_FillVehicles::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Array_Length_ReturnValue_1) == 0x0000D0, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_FactionUnitDetails_C_FillVehicles, CallFunc_Less_IntInt_ReturnValue_1) == 0x0000D4, "Member 'W_FactionUnitDetails_C_FillVehicles::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(W_FactionUnitDetails_C_GetSimpleRow, Index_0) == 0x000000, "Member 'W_FactionUnitDetails_C_GetSimpleRow::Index_0' has a wrong offset!");
