...
public:
	...
	TMulticastInlineDelegate<void(bool bCenterHovered)> CenterHoverChanged;                          // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
