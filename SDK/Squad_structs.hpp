...
public:
	...
	TMulticastInlineDelegate<void(const TArray<int32>& MapMarkerAddedIndices)> MapMarkerCreatedEvent; // 0x0128(0x0010)(ZeroConstructor, InstancedReference, RepSkip, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const TArray<int32>& MapMarkerDeletedIndices)> MapMarkerDeletedEvent; // 0x0138(0x0010)(ZeroConstructor, InstancedReference, RepSkip, NativeAccessSpecifierPublic)
};
