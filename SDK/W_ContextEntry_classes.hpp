...
public:
	...
	class FText                                   Name_0;                                            // 0x0278(0x0018)(Edit, BlueprintVisible, ExposeOnSpawn)
	TMulticastInlineDelegate<void(int32 Index)>   OnActionPressed;                                   // 0x0290(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
static_assert(offsetof(UW_ContextEntry_C, Name_0) == 0x000278, "Member 'UW_ContextEntry_C::Name_0' has a wrong offset!");
...
static_assert(offsetof(UW_ContextEntry_C, Index_0) == 0x0002A0, "Member 'UW_ContextEntry_C::Index_0' has a wrong offset!");
