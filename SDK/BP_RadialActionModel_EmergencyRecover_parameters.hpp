...
{
public:
	class USQRadialButton*                        Widget_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_RadialActionModel_EmergencyRecover_C_Populate, Widget_0) == 0x000000, "Member 'BP_RadialActionModel_EmergencyRecover_C_Populate::Widget_0' has a wrong offset!");
...
public:
	class USQRadialButton*                        Widget_0;                                          // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ASQVehicle*                             Vehicle_0;                                         // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_RadialActionModel_EmergencyRecover_C_Update_Button, Widget_0) == 0x000000, "Member 'BP_RadialActionModel_EmergencyRecover_C_Update_Button::Widget_0' has a wrong offset!");
static_assert(offsetof(BP_RadialActionModel_EmergencyRecover_C_Update_Button, Vehicle_0) == 0x000008, "Member 'BP_RadialActionModel_EmergencyRecover_C_Update_Button::Vehicle_0' has a wrong offset!");
...
{
public:
	class ASQVehicle*                             Vehicle_0;                                         // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(BP_RadialActionModel_EmergencyRecover_C_Get_Correct_Recovery_Methods, Vehicle_0) == 0x000000, "Member 'BP_RadialActionModel_EmergencyRecover_C_Get_Correct_Recovery_Methods::Vehicle_0' has a wrong offset!");
