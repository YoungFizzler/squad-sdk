...
public:
	...
	TMulticastInlineDelegate<void(class FText Reason, class FText Time)> OnExecuteBan;               // 0x0298(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
