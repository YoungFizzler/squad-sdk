...
{
public:
	int32                                         Seat_Index_0;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class ASQPlayerState*                         Player_State_0;                                    // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          Driver_0;                                          // 0x0010(0x0001)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(W_VehicleSeatInfo_C_Update_Occupant, Seat_Index_0) == 0x000000, "Member 'W_VehicleSeatInfo_C_Update_Occupant::Seat_Index_0' has a wrong offset!");
static_assert(offsetof(W_VehicleSeatInfo_C_Update_Occupant, Player_State_0) == 0x000008, "Member 'W_VehicleSeatInfo_C_Update_Occupant::Player_State_0' has a wrong offset!");
static_assert(offsetof(W_VehicleSeatInfo_C_Update_Occupant, Driver_0) == 0x000010, "Member 'W_VehicleSeatInfo_C_Update_Occupant::Driver_0' has a wrong offset!");
