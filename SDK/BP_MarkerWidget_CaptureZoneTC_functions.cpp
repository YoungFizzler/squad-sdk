...
// bool*                                   Can_Cap_0                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UBP_MarkerWidget_CaptureZoneTC_C::Can_Cap(class ATC_HexZone_C* Zone, bool Self_Team, bool* Can_Cap_0)
{
	static class UFunction* Func = nullptr;
	...
	if (Can_Cap_0 != nullptr)
		*Can_Cap_0 = Parms.Can_Cap_0;
}
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// uint8*                                  OwningTeam_0                                           (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_MarkerWidget_CaptureZoneTC_C::Get_Hex_Owning_Team(uint8* OwningTeam_0)
{
	static class UFunction* Func = nullptr;
	...
	if (OwningTeam_0 != nullptr)
		*OwningTeam_0 = Parms.OwningTeam_0;
}
