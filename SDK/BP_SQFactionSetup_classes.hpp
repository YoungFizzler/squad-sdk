...
public:
	void TryGetRoleGroupingStrategies(bool* Success, TArray<struct FSQRoleGroupingStrategy>* RoleGroupingStrategies_0);
	...
	void GetOuterFaction(bool* Out_Success, class UBP_SQFaction_C** OuterFaction_0) const;
