...
{
public:
	int32                                         NewTicketValue;                                    // 0x0000(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         TicketChange;                                      // 0x0004(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class ASQGameState*                           CallFunc_GetSquadGameState_Return_Value;           // 0x0028(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, NewTicketValue) == 0x000000, "Member 'GraphMercyBleedComponent_C_TickBleed::NewTicketValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, TicketChange) == 0x000004, "Member 'GraphMercyBleedComponent_C_TickBleed::TicketChange' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CachedTickets) == 0x000008, "Member 'GraphMercyBleedComponent_C_TickBleed::CachedTickets' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, Temp_int_Loop_Counter_Variable) == 0x00000C, "Member 'GraphMercyBleedComponent_C_TickBleed::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, Temp_int_Array_Index_Variable) == 0x000014, "Member 'GraphMercyBleedComponent_C_TickBleed::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, Temp_bool_Variable) == 0x000018, "Member 'GraphMercyBleedComponent_C_TickBleed::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Subtract_IntInt_ReturnValue) == 0x00001C, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Array_Length_ReturnValue) == 0x000020, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Greater_IntInt_ReturnValue) == 0x000024, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_GetSquadGameState_Return_Value) == 0x000028, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_GetSquadGameState_Return_Value' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Clamp_ReturnValue) == 0x000030, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Array_Get_Item) == 0x000038, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Array_Length_ReturnValue_1) == 0x000040, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_GetTickets_ReturnValue) == 0x000044, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_GetTickets_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Less_IntInt_ReturnValue) == 0x000048, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Add_IntInt_ReturnValue_1) == 0x00004C, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Add_IntInt_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000050, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_IsValid_ReturnValue) == 0x000051, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, CallFunc_Array_Contains_ReturnValue) == 0x000052, "Member 'GraphMercyBleedComponent_C_TickBleed::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(GraphMercyBleedComponent_C_TickBleed, K2Node_Select_Default) == 0x000054, "Member 'GraphMercyBleedComponent_C_TickBleed::K2Node_Select_Default' has a wrong offset!");
