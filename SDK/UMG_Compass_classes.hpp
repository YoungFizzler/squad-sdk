...
public:
	...
	TMulticastInlineDelegate<void()>              CheckVisibilityStatus_0;                           // 0x03A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void BPInit();
	void Construct();
	void ChangeDisplayMode(bool bTopScreenView_0);
