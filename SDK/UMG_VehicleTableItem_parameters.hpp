...
{
public:
	TSoftObjectPtr<class UTexture2D>              VehicleImage_0;                                    // 0x0000(0x0028)(BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
static_assert(offsetof(UMG_VehicleTableItem_C_Setup, VehicleImage_0) == 0x000000, "Member 'UMG_VehicleTableItem_C_Setup::VehicleImage_0' has a wrong offset!");
