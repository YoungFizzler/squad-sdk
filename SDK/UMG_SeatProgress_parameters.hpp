...
public:
	...
	float                                         CallFunc_GetEnterSeatDuration_Duration;            // 0x0010(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UMG_SeatProgress_C_Create_Radial, CallFunc_GetEnterSeatDuration_Duration) == 0x000010, "Member 'UMG_SeatProgress_C_Create_Radial::CallFunc_GetEnterSeatDuration_Duration' has a wrong offset!");
static_assert(offsetof(UMG_SeatProgress_C_Create_Radial, CallFunc_IsValid_ReturnValue) == 0x000014, "Member 'UMG_SeatProgress_C_Create_Radial::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
// Function UMG_SeatProgress.UMG_SeatProgress_C.GetEnterSeatDuration
// 0x000C (0x000C - 0x0000)
struct UMG_SeatProgress_C_GetEnterSeatDuration final
{
public:
	float                                         Duration;                                          // 0x0000(0x0004)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0004(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_5[0x3];                                        // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         CallFunc_GetSeatEnterDuration_ReturnValue;         // 0x0008(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(UMG_SeatProgress_C_GetEnterSeatDuration) == 0x000004, "Wrong alignment on UMG_SeatProgress_C_GetEnterSeatDuration");
static_assert(sizeof(UMG_SeatProgress_C_GetEnterSeatDuration) == 0x00000C, "Wrong size on UMG_SeatProgress_C_GetEnterSeatDuration");
static_assert(offsetof(UMG_SeatProgress_C_GetEnterSeatDuration, Duration) == 0x000000, "Member 'UMG_SeatProgress_C_GetEnterSeatDuration::Duration' has a wrong offset!");
static_assert(offsetof(UMG_SeatProgress_C_GetEnterSeatDuration, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'UMG_SeatProgress_C_GetEnterSeatDuration::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_SeatProgress_C_GetEnterSeatDuration, CallFunc_GetSeatEnterDuration_ReturnValue) == 0x000008, "Member 'UMG_SeatProgress_C_GetEnterSeatDuration::CallFunc_GetSeatEnterDuration_ReturnValue' has a wrong offset!");
