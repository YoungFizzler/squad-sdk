...
public:
	...
	ESQSpawnPointType                             Temp_byte_Variable;                                // 0x0044(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsAnimationPlaying_ReturnValue;           // 0x0045(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	float                                         K2Node_Event_UniformScale;                         // 0x0058(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_5C[0x4];                                       // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UW_DeployConfirmation_C*>        CallFunc_GetAllWidgetsOfClass_FoundWidgets;        // 0x0060(0x0010)(ReferenceParm, ContainsInstancedReference)
	class UW_DeployConfirmation_C*                CallFunc_Array_Get_Item;                           // 0x0070(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint) == 0x000080, "Wrong size on BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint");
...
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_int_Loop_Counter_Variable) == 0x000004, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_int_Loop_Counter_Variable' has a wrong offset!");
...
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_Add_IntInt_ReturnValue) == 0x000010, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_object_Variable_1) == 0x000018, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_object_Variable_1' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_object_Variable_2) == 0x000020, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_object_Variable_2' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_object_Variable_3) == 0x000028, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_object_Variable_3' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_object_Variable_4) == 0x000030, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_object_Variable_4' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_object_Variable_5) == 0x000038, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_object_Variable_5' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_int_Array_Index_Variable) == 0x000040, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, Temp_byte_Variable) == 0x000044, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_IsAnimationPlaying_ReturnValue) == 0x000045, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_IsAnimationPlaying_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_PlayAnimation_ReturnValue) == 0x000048, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_PlayAnimation_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, K2Node_Select_Default) == 0x000050, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, K2Node_Event_UniformScale) == 0x000058, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::K2Node_Event_UniformScale' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_GetAllWidgetsOfClass_FoundWidgets) == 0x000060, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_GetAllWidgetsOfClass_FoundWidgets' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_Array_Get_Item) == 0x000070, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_Array_Length_ReturnValue) == 0x000078, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint, CallFunc_Less_IntInt_ReturnValue) == 0x00007C, "Member 'BP_MapWidgetSpawnPoint_C_ExecuteUbergraph_BP_MapWidgetSpawnPoint::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000007, "Member 'BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility, CallFunc_BooleanOR_ReturnValue) == 0x000010, "Member 'BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility, K2Node_Select_Default) == 0x000011, "Member 'BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility, K2Node_Select_Default_1) == 0x000012, "Member 'BP_MapWidgetSpawnPoint_C_Update_Spawns_Visibility::K2Node_Select_Default_1' has a wrong offset!");
