...
public:
	...
	class UW_CommandActionItem_C*                 CallFunc_Array_Get_Item;                           // 0x0068(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_Array_Length_ReturnValue;                 // 0x0070(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_Less_IntInt_ReturnValue;                  // 0x0074(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_75[0x3];                                       // 0x0075(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         CallFunc_Array_Length_ReturnValue_1;               // 0x0078(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_7C[0x4];                                       // 0x007C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCommanderCategory                     CallFunc_Array_Get_Item_1;                         // 0x0080(0x0020)()
...
static_assert(sizeof(W_CommandRequestList_C_Init_Action_List) == 0x0000A8, "Wrong size on W_CommandRequestList_C_Init_Action_List");
...
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_NotEqual_ObjectObject_ReturnValue) == 0x000060, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_NotEqual_ObjectObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_Array_Get_Item) == 0x000068, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_Array_Length_ReturnValue) == 0x000070, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_Less_IntInt_ReturnValue) == 0x000074, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_Array_Length_ReturnValue_1) == 0x000078, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_Array_Length_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_Array_Get_Item_1) == 0x000080, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_Array_Get_Item_1' has a wrong offset!");
static_assert(offsetof(W_CommandRequestList_C_Init_Action_List, CallFunc_Less_IntInt_ReturnValue_1) == 0x0000A0, "Member 'W_CommandRequestList_C_Init_Action_List::CallFunc_Less_IntInt_ReturnValue_1' has a wrong offset!");
