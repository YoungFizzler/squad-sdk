...
{
public:
	int32                                         Objective_Owner_0;                                 // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(W_DestructionObjectiveEvent_C_Play_Destroy_Animation, Objective_Owner_0) == 0x000000, "Member 'W_DestructionObjectiveEvent_C_Play_Destroy_Animation::Objective_Owner_0' has a wrong offset!");
