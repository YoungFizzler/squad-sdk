...
public:
	...
	class USQMapIconComponent*                    SquadMapIcon;                                      // 0x0590(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NonTransactional, NoDestructor, HasGetValueTypeHash)
	TArray<struct FSQFOBDeployableCount>          DeployableCount;                                   // 0x0598(0x0010)(Edit, BlueprintVisible, Net, Transient)
...
static_assert(sizeof(ABP_ForwardBase_C) == 0x0005A8, "Wrong size on ABP_ForwardBase_C");
static_assert(offsetof(ABP_ForwardBase_C, UberGraphFrame) == 0x000588, "Member 'ABP_ForwardBase_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_ForwardBase_C, SquadMapIcon) == 0x000590, "Member 'ABP_ForwardBase_C::SquadMapIcon' has a wrong offset!");
static_assert(offsetof(ABP_ForwardBase_C, DeployableCount) == 0x000598, "Member 'ABP_ForwardBase_C::DeployableCount' has a wrong offset!");
