...
// Parameters:
// class UPanelWidget**                    RoleBox_0                                              (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_RoleGroup_C::Get_Role_Panel(class UPanelWidget** RoleBox_0)
{
	static class UFunction* Func = nullptr;
	...
	if (RoleBox_0 != nullptr)
		*RoleBox_0 = Parms.RoleBox_0;
}
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// const struct FSQRoleGroupingStrategy&   In_Group_Strategy                                      (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// bool*                                   Out_Success                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
