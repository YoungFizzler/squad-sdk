...
public:
	...
	TMulticastInlineDelegate<void()>              Option_Changed;                                    // 0x0308(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              RequestClose;                                      // 0x0378(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMap<class FString, class FName>              GameModeOptionTagMap;                              // 0x0440(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)

public:
	void ExecuteUbergraph_W_QuickPlayPreferences(int32 EntryPoint);
	void BndEvt__W_QuickPlayPreferences_Settings_MapRot_K2Node_ComponentBoundEvent_8_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__W_QuickPlayPreferences_Settings_Experience_K2Node_ComponentBoundEvent_7_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__W_QuickPlayPreferences_Settings_Playstyle_K2Node_ComponentBoundEvent_6_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__W_QuickPlayPreferences_Settings_QPType_K2Node_ComponentBoundEvent_5_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__W_QuickPlayPreferences_Settings_ElapsedTime_K2Node_ComponentBoundEvent_4_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__W_QuickPlayPreferences_Settings_MinPlayers_K2Node_ComponentBoundEvent_3_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
	void BndEvt__W_QuickPlayPreferences_SettingsComboboxItem_K2Node_ComponentBoundEvent_2_OnValueChanged__DelegateSignature(const class FString& Option, int32 Index_0);
...
static_assert(sizeof(UW_QuickPlayPreferences_C) == 0x000490, "Wrong size on UW_QuickPlayPreferences_C");
...
static_assert(offsetof(UW_QuickPlayPreferences_C, GameModeOptionTagMap) == 0x000440, "Member 'UW_QuickPlayPreferences_C::GameModeOptionTagMap' has a wrong offset!");
