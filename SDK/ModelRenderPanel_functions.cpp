...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// float                                   CustomOrthoWidth_0                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UModelRenderPanel_C::SetCustomOrthoWidth(float CustomOrthoWidth_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CustomOrthoWidth_0 = CustomOrthoWidth_0;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FPostProcessSettings&      InPostProcessSettings                                  (BlueprintVisible, BlueprintReadOnly, Parm)
