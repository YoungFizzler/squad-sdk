...
public:
	...
	TMulticastInlineDelegate<void(int32 ActionIndex)> OnActionExecuted;                              // 0x0278(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void OnHoveredEnd();
	void OnEntryPressed(int32 Index_0);
