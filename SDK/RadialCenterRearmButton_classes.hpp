...
public:
	...
	TMulticastInlineDelegate<void(float AmmoRemaining)> UpdateAmmoRemaining;                         // 0x0500(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              InventoryUpdated;                                  // 0x0530(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void SetInventoryComponent(class USQPawnInventoryComponent* InventoryComponent_0);
	void OnHoverEnd();
	void RearmWeapons();
