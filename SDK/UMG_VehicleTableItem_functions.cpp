...
// Parameters:
// TSoftObjectPtr<class UTexture2D>        VehicleImage_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// const class FText&                      MainName                                               (BlueprintVisible, BlueprintReadOnly, Parm)
...
// const class FText&                      Ticket                                                 (BlueprintVisible, BlueprintReadOnly, Parm)
// bool                                    Amphibious                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UUMG_VehicleTableItem_C::Setup(TSoftObjectPtr<class UTexture2D> VehicleImage_0, const class FText& MainName, const class FText& Count, const class FText& Time, const class FText& Ticket, bool Amphibious)
{
	...
	Parms.VehicleImage_0 = VehicleImage_0;
