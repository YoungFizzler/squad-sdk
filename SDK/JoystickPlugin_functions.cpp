...
// const struct FJoystickState&            State                                                  (Parm, NativeAccessSpecifierPublic)
// const struct FJoystickState&            prev                                                   (Parm, NativeAccessSpecifierPublic)
...
void IJoystickInterface::JoystickAxisChanged(int32 Axis, float Value, float valuePrev, const struct FJoystickState& State, const struct FJoystickState& prev)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickAxisChanged");
...
// const struct FVector2D&                 Delta                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// const struct FJoystickState&            State                                                  (Parm, NativeAccessSpecifierPublic)
...
void IJoystickInterface::JoystickBallMoved(int32 Ball, const struct FVector2D& Delta, const struct FJoystickState& State)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickBallMoved");
...
void IJoystickInterface::JoystickButtonPressed(int32 Button, const struct FJoystickState& State)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickButtonPressed");
...
void IJoystickInterface::JoystickButtonReleased(int32 Button, const struct FJoystickState& State)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickButtonReleased");
...
void IJoystickInterface::JoystickHatChanged(int32 Hat, EJoystickPOVDirection Value, const struct FJoystickState& State)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickHatChanged");
...
void IJoystickInterface::JoystickPluggedIn(int32 DeviceID)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickPluggedIn");
...
void IJoystickInterface::JoystickUnplugged(int32 DeviceID)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("JoystickInterface", "JoystickUnplugged");
