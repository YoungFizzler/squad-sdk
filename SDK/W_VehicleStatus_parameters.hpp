...
public:
	...
	struct FSQVehicleSeatConfig                   CallFunc_Array_Get_Item_1;                         // 0x00A0(0x0070)()
...
static_assert(sizeof(W_VehicleStatus_C_Update_Turret_State) == 0x000118, "Wrong size on W_VehicleStatus_C_Update_Turret_State");
...
static_assert(offsetof(W_VehicleStatus_C_Update_Turret_State, CallFunc_Array_IsValidIndex_ReturnValue) == 0x000110, "Member 'W_VehicleStatus_C_Update_Turret_State::CallFunc_Array_IsValidIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_VehicleStatus_C_Update_Turret_State, CallFunc_Greater_FloatFloat_ReturnValue_1) == 0x000111, "Member 'W_VehicleStatus_C_Update_Turret_State::CallFunc_Greater_FloatFloat_ReturnValue_1' has a wrong offset!");
