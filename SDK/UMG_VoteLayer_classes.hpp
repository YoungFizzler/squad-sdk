...
public:
	...
	TMulticastInlineDelegate<void(class FName LayerID)> LayerInfoRequested;                          // 0x02A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
