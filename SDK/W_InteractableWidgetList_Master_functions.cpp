...
// Parameters:
// const struct FSQUsableWidgetData&       Interact_Data_0                                        (BlueprintVisible, BlueprintReadOnly, Parm)
// class AActor*                           Actor                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_InteractableWidgetList_Master_C::Set_Interact_Data(const struct FSQUsableWidgetData& Interact_Data_0, class AActor* Actor)
{
	static class UFunction* Func = nullptr;
	...
	Parms.Interact_Data_0 = std::move(Interact_Data_0);
	Parms.Actor = Actor;
...
void UW_InteractableWidgetList_Master_C::Fade_Anim(bool Open_0)
{
	static class UFunction* Func = nullptr;
