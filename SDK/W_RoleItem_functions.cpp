...
// Parameters:
// const TArray<struct FSQAvailabilityState_Role>&In_Player_Role_States                                  (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSQAvailabilityState_Role& InTeamRoleAvailabilityState                            (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSQAvailabilityState_Role& InState                                                (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// Parameters:
// const struct FSQRoleGroupingStrategy&   InTagGrouping                                          (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSQRoleGroupingStrategy&   InTagGroupingStrategy                                  (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
