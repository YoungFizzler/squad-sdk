...
static_assert(offsetof(W_RadialWheel_C_Radial_Option_Released, Index_0) == 0x000000, "Member 'W_RadialWheel_C_Radial_Option_Released::Index_0' has a wrong offset!");
