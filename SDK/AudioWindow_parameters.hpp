...
static_assert(offsetof(AudioWindow_C_BndEvt__AUDIOINPUTDEVICE_K2Node_ComponentBoundEvent_3_OnValueChanged__DelegateSignature, Index_0) == 0x000010, "Member 'AudioWindow_C_BndEvt__AUDIOINPUTDEVICE_K2Node_ComponentBoundEvent_3_OnValueChanged__DelegateSignature::Index_0' has a wrong offset!");
...
static_assert(offsetof(AudioWindow_C_BndEvt__AUDIOOUTPUTDEVICE_K2Node_ComponentBoundEvent_1_OnValueChanged__DelegateSignature, Index_0) == 0x000010, "Member 'AudioWindow_C_BndEvt__AUDIOOUTPUTDEVICE_K2Node_ComponentBoundEvent_1_OnValueChanged__DelegateSignature::Index_0' has a wrong offset!");
