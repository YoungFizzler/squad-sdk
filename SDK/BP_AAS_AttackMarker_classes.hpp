...
static_assert(sizeof(ABP_AAS_AttackMarker_C) == 0x000278, "Wrong size on ABP_AAS_AttackMarker_C");
static_assert(offsetof(ABP_AAS_AttackMarker_C, DefaultSceneRoot) == 0x000270, "Member 'ABP_AAS_AttackMarker_C::DefaultSceneRoot' has a wrong offset!");
