...
public:
	...
	TArray<struct FTeamVehicleRuleElement>        Rules;                                             // 0x0270(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
...
public:
	...
	void ApplyRules(TArray<struct FVehicleRuleElement>& In_Vehicle_Rule, class UBP_SQVehicleSettings_C* In_Vehicle_Settings, class ASQPlayerController* In_Killer, class ASQTeamState* In_Victim_TeamState, class ASQTeamState* In_Kill_Instigator_TeamState, class ASQVehicle* Vehicle);
...
static_assert(sizeof(ABP_Ruleset_Vehicle_C) == 0x000280, "Wrong size on ABP_Ruleset_Vehicle_C");
static_assert(offsetof(ABP_Ruleset_Vehicle_C, UberGraphFrame) == 0x000260, "Member 'ABP_Ruleset_Vehicle_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_Ruleset_Vehicle_C, DefaultSceneRoot) == 0x000268, "Member 'ABP_Ruleset_Vehicle_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_Ruleset_Vehicle_C, Rules) == 0x000270, "Member 'ABP_Ruleset_Vehicle_C::Rules' has a wrong offset!");
