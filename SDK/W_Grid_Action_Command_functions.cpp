...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FLinearColor*                    Tint_0                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UW_Grid_Action_Command_C::Get_Color(struct FLinearColor* Tint_0)
{
	static class UFunction* Func = nullptr;
