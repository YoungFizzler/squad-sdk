...
// 0x0001 (0x0001 - 0x0000)
struct SQWaterPointTestComponent_GetIsPointImmersed final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(SQWaterPointTestComponent_GetIsPointImmersed) == 0x000001, "Wrong alignment on SQWaterPointTestComponent_GetIsPointImmersed");
static_assert(sizeof(SQWaterPointTestComponent_GetIsPointImmersed) == 0x000001, "Wrong size on SQWaterPointTestComponent_GetIsPointImmersed");
static_assert(offsetof(SQWaterPointTestComponent_GetIsPointImmersed, ReturnValue) == 0x000000, "Member 'SQWaterPointTestComponent_GetIsPointImmersed::ReturnValue' has a wrong offset!");
...
{
public:
	class USQBuoyancyComponent*                   BuoyancyComponent_0;                               // 0x0000(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
static_assert(offsetof(ODKWaterMovementComponent_SetBuoyancyComponent, BuoyancyComponent_0) == 0x000000, "Member 'ODKWaterMovementComponent_SetBuoyancyComponent::BuoyancyComponent_0' has a wrong offset!");
