...
{
public:
	float                                         TargetZoom_0;                                      // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(W_SQMapCore_C_PerformZoom, TargetZoom_0) == 0x000000, "Member 'W_SQMapCore_C_PerformZoom::TargetZoom_0' has a wrong offset!");
...
{
public:
	class USQCoreStateMapComponent*               MapComponent_0;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(W_SQMapCore_C_Setup, MapComponent_0) == 0x000000, "Member 'W_SQMapCore_C_Setup::MapComponent_0' has a wrong offset!");
...
static_assert(offsetof(W_SQMapCore_C_AdjustHorizontalBarPadding, TargetZoom_0) == 0x000000, "Member 'W_SQMapCore_C_AdjustHorizontalBarPadding::TargetZoom_0' has a wrong offset!");
...
static_assert(offsetof(W_SQMapCore_C_AdjustVerticalBarPadding, TargetZoom_0) == 0x000000, "Member 'W_SQMapCore_C_AdjustVerticalBarPadding::TargetZoom_0' has a wrong offset!");
