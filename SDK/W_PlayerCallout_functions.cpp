...
// Parameters:
// const class FText&                      TopText_0                                              (BlueprintVisible, BlueprintReadOnly, Parm)
// TSoftObjectPtr<class UTexture2D>        ImageRef                                               (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
// const class FText&                      BottomText_0                                           (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      InTooltip                                              (BlueprintVisible, BlueprintReadOnly, Parm)
// const class FText&                      InAdditionalText                                       (BlueprintVisible, BlueprintReadOnly, Parm)
