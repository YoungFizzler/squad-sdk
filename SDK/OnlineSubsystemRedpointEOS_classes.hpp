...
static_assert(alignof(IEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform) == 0x000001, "Wrong alignment on IEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform");
static_assert(sizeof(IEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform) == 0x000001, "Wrong size on IEOSUserInterface_LinkEOSAccountsAgainstCrossPlatform");
...
static_assert(alignof(IEOSUserInterface_SelectEOSAccount) == 0x000001, "Wrong alignment on IEOSUserInterface_SelectEOSAccount");
static_assert(sizeof(IEOSUserInterface_SelectEOSAccount) == 0x000001, "Wrong size on IEOSUserInterface_SelectEOSAccount");
...
static_assert(alignof(IEOSUserInterface_SwitchToCrossPlatformAccount) == 0x000001, "Wrong alignment on IEOSUserInterface_SwitchToCrossPlatformAccount");
