...
public:
	...
	TDelegate<void(const struct FCrossPromotionData& PromotionData)> K2Node_CreateDelegate_OutputDelegate; // 0x0080(0x0010)(ZeroConstructor, NoDestructor)
...
public:
	...
	TDelegate<void(const class USQCdnFile* File)> K2Node_CreateDelegate_OutputDelegate;              // 0x0258(0x0010)(ZeroConstructor, NoDestructor)
};
