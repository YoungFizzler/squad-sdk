...
public:
	...
	bool                                          CallFunc_NotEqual_FloatFloat_ReturnValue;          // 0x01B9(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
static_assert(alignof(W_RadialTowingWidget_C_UpdateText) == 0x000008, "Wrong alignment on W_RadialTowingWidget_C_UpdateText");
static_assert(sizeof(W_RadialTowingWidget_C_UpdateText) == 0x0001C0, "Wrong size on W_RadialTowingWidget_C_UpdateText");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_MakeLiteralText_ReturnValue) == 0x000000, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_MakeLiteralText_ReturnValue_1) == 0x000018, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_MakeLiteralText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_MakeStruct_FormatArgumentData) == 0x000030, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_MakeStruct_FormatArgumentData_1) == 0x000070, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_SwitchEnum_CmpSuccess) == 0x0000B0, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_Abs_ReturnValue) == 0x0000B4, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_Abs_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_Conv_FloatToText_ReturnValue) == 0x0000B8, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_Conv_FloatToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_Conv_FloatToText_ReturnValue_1) == 0x0000D0, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_Conv_FloatToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_MakeStruct_FormatArgumentData_2) == 0x0000E8, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_MakeStruct_FormatArgumentData_3) == 0x000128, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_MakeStruct_FormatArgumentData_3' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_MakeArray_Array) == 0x000168, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, K2Node_MakeArray_Array_1) == 0x000178, "Member 'W_RadialTowingWidget_C_UpdateText::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_Format_ReturnValue) == 0x000188, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_Format_ReturnValue_1) == 0x0001A0, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_Format_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_Less_FloatFloat_ReturnValue) == 0x0001B8, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_Less_FloatFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_RadialTowingWidget_C_UpdateText, CallFunc_NotEqual_FloatFloat_ReturnValue) == 0x0001B9, "Member 'W_RadialTowingWidget_C_UpdateText::CallFunc_NotEqual_FloatFloat_ReturnValue' has a wrong offset!");
