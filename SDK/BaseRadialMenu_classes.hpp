...
public:
	...
	TMulticastInlineDelegate<void(int32 OptionIndex, class UBaseRadialMenu_C* Context)> OnOptionClicked; // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UBaseRadialMenu_C* Context)> OnCenterClicked;                // 0x02D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              HoverWidgetChanged;                                // 0x0310(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(bool Centre_Hovered)> Centre_Hover_Changed;                        // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnRadialMenuDestroyed;                             // 0x0358(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnSelfClosed;                                      // 0x0398(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)

public:
	void ExecuteUbergraph_BaseRadialMenu(int32 EntryPoint);
	void ButtonRelease(class UBP_RadialItemModel_C* Item);
	void Radial_Option_Released(int32 Index_0);
	void Reset(bool bCenterMouse);
	void ButtonPress(class UBP_RadialItemModel_C* Item);
	void Radial_Option_Clicked(int32 Index_0);
