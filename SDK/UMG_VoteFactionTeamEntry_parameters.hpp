...
{
public:
	int32                                         VoteCount_0;                                       // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UMG_VoteFactionTeamEntry_C_OnUpdateVote, VoteCount_0) == 0x000000, "Member 'UMG_VoteFactionTeamEntry_C_OnUpdateVote::VoteCount_0' has a wrong offset!");
