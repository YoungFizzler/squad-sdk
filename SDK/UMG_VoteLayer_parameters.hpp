...
public:
	...
	class FName                                   PlayerName_0;                                      // 0x0018(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(UMG_VoteLayer_C_OnSetup, PlayerName_0) == 0x000018, "Member 'UMG_VoteLayer_C_OnSetup::PlayerName_0' has a wrong offset!");
