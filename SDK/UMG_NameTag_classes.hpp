...
public:
	...
	struct FVector2D                              Desired_Screen_Location;                           // 0x0310(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UCanvasPanelSlot*                       My_Canvas_Slot;                                    // 0x0318(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Close_Range_for_Close_Angle___cm_;                 // 0x0320(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Far_Range_for_Far_Angle__cm_;                      // 0x0324(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Required_Close_Angle__0_1_;                        // 0x0328(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Required_Far_Angle__0_0_9999_;                     // 0x032C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Maximum_Range_Whole__cm_;                          // 0x0330(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Minimum_Fade_Range_My_SL__cm_;                     // 0x0334(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         Maximum_Fade_Range_My_SL__cm_;                     // 0x0338(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          In_Threshold;                                      // 0x033C(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_33D[0x3];                                      // 0x033D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FCachedNametagTargetInfo               CachedTargetInfo;                                  // 0x0340(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance, HasGetValueTypeHash)
...
static_assert(offsetof(UUMG_NameTag_C, Desired_Screen_Location) == 0x000310, "Member 'UUMG_NameTag_C::Desired_Screen_Location' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, My_Canvas_Slot) == 0x000318, "Member 'UUMG_NameTag_C::My_Canvas_Slot' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Close_Range_for_Close_Angle___cm_) == 0x000320, "Member 'UUMG_NameTag_C::Close_Range_for_Close_Angle___cm_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Far_Range_for_Far_Angle__cm_) == 0x000324, "Member 'UUMG_NameTag_C::Far_Range_for_Far_Angle__cm_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Required_Close_Angle__0_1_) == 0x000328, "Member 'UUMG_NameTag_C::Required_Close_Angle__0_1_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Required_Far_Angle__0_0_9999_) == 0x00032C, "Member 'UUMG_NameTag_C::Required_Far_Angle__0_0_9999_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Maximum_Range_Whole__cm_) == 0x000330, "Member 'UUMG_NameTag_C::Maximum_Range_Whole__cm_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Minimum_Fade_Range_My_SL__cm_) == 0x000334, "Member 'UUMG_NameTag_C::Minimum_Fade_Range_My_SL__cm_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, Maximum_Fade_Range_My_SL__cm_) == 0x000338, "Member 'UUMG_NameTag_C::Maximum_Fade_Range_My_SL__cm_' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, In_Threshold) == 0x00033C, "Member 'UUMG_NameTag_C::In_Threshold' has a wrong offset!");
static_assert(offsetof(UUMG_NameTag_C, CachedTargetInfo) == 0x000340, "Member 'UUMG_NameTag_C::CachedTargetInfo' has a wrong offset!");
