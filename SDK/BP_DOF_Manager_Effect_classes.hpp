...
public:
	...
	void BP_ApplyCameraEffect(float DeltaTime_0, class ASQSoldier* SoldierToApplyTo);
	...
	void Scale_DOF_by_FOV(float InBaselineFOV, float InBaselineFocusDistance, float InBaselineF_stop, float InTargetFOV, float* OutF_Stop, float* OutFocusDistance) const;
