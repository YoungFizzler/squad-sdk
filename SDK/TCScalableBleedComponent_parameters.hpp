...
static_assert(sizeof(TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent) == 0x000030, "Wrong size on TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent");
...
static_assert(offsetof(TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent, K2Node_CreateDelegate_OutputDelegate) == 0x000004, "Member 'TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent, CallFunc_GetOwner_ReturnValue) == 0x000020, "Member 'TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent::CallFunc_GetOwner_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent, CallFunc_HasAuthority_ReturnValue) == 0x000028, "Member 'TCScalableBleedComponent_C_ExecuteUbergraph_TCScalableBleedComponent::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
...
{
public:
	TArray<class ATC_HexZone_C*>                  All_TC_Zones_0;                                    // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
static_assert(offsetof(TCScalableBleedComponent_C_Initialise_TC_Bleed_Component, All_TC_Zones_0) == 0x000000, "Member 'TCScalableBleedComponent_C_Initialise_TC_Bleed_Component::All_TC_Zones_0' has a wrong offset!");
...
// 0x0048 (0x0048 - 0x0000)
struct TCScalableBleedComponent_C_Apply_Bleed_Per_Minute final
{
public:
	...
	class ASQTeamState*                           CallFunc_Array_Get_Item;                           // 0x0020(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetTickets_ReturnValue;                   // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute) == 0x000008, "Wrong alignment on TCScalableBleedComponent_C_Apply_Bleed_Per_Minute");
static_assert(sizeof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute) == 0x000048, "Wrong size on TCScalableBleedComponent_C_Apply_Bleed_Per_Minute");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, NewTicketsValue) == 0x000000, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::NewTicketsValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, Temp_int_Array_Index_Variable) == 0x000004, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, Temp_int_Loop_Counter_Variable) == 0x000008, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_GetSquadGameState_Return_Value) == 0x000010, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_GetSquadGameState_Return_Value' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Add_IntInt_ReturnValue) == 0x000018, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Array_Get_Item) == 0x000020, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_GetTickets_ReturnValue) == 0x000028, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_GetTickets_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_IsValid_ReturnValue) == 0x00002C, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Subtract_IntInt_ReturnValue) == 0x000030, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000034, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Array_Length_ReturnValue) == 0x000038, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Less_IntInt_ReturnValue) == 0x00003C, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Clamp_ReturnValue) == 0x000040, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(TCScalableBleedComponent_C_Apply_Bleed_Per_Minute, CallFunc_Subtract_IntInt_ReturnValue_1) == 0x000044, "Member 'TCScalableBleedComponent_C_Apply_Bleed_Per_Minute::CallFunc_Subtract_IntInt_ReturnValue_1' has a wrong offset!");
