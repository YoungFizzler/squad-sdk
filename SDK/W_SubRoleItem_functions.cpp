...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSQAvailabilityState_Role& In_Role_State                                          (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
void UW_SubRoleItem_C::Get_Weapon_Name(class FText* Name_0, struct FSQInventoryData* Inventory)
{
	static class UFunction* Func = nullptr;
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// const struct FSQInventoryData&          SQInventoryData                                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
