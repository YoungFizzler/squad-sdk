...
public:
	...
	TDelegate<void(class USQGuidanceComponent* GuidanceComponent, const EGuidanceLossReason LossReason)> K2Node_CreateDelegate_OutputDelegate; // 0x0010(0x0010)(ZeroConstructor, NoDestructor)
...
public:
	...
	TDelegate<void(class USQGuidanceComponent* GuidanceComponent, const EGuidanceLossReason LossReason)> K2Node_CreateDelegate_OutputDelegate_1; // 0x0034(0x0010)(ZeroConstructor, NoDestructor)
};
