...
public:
	...
	struct FEmoteAnimationData                    K2Node_CustomEvent_EmoteAnimationData;             // 0x0028(0x00F8)()
	...
	float                                         K2Node_CustomEvent_New_Rotation_Z__Yaw_;           // 0x0124(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview) == 0x0001C8, "Wrong size on W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview");
...
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, CallFunc_IsValid_ReturnValue) == 0x000004, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, CallFunc_GetOwningPlayer_ReturnValue) == 0x000008, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::CallFunc_GetOwningPlayer_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, K2Node_CustomEvent_New_Role) == 0x000010, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::K2Node_CustomEvent_New_Role' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, K2Node_DynamicCast_AsSQPlayer_Controller) == 0x000018, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::K2Node_DynamicCast_AsSQPlayer_Controller' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, K2Node_DynamicCast_bSuccess) == 0x000020, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::K2Node_DynamicCast_bSuccess' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, K2Node_CustomEvent_EmoteAnimationData) == 0x000028, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::K2Node_CustomEvent_EmoteAnimationData' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, CallFunc_IsValid_ReturnValue_1) == 0x000120, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, Temp_bool_Variable) == 0x000121, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, K2Node_CustomEvent_New_Rotation_Z__Yaw_) == 0x000124, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::K2Node_CustomEvent_New_Rotation_Z__Yaw_' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, CallFunc_MakeRotator_ReturnValue) == 0x000128, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::CallFunc_MakeRotator_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, CallFunc_K2_SetRelativeRotation_SweepHitResult) == 0x000134, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::CallFunc_K2_SetRelativeRotation_SweepHitResult' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, CallFunc_IsValid_ReturnValue_2) == 0x0001BC, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::CallFunc_IsValid_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview, K2Node_Select_Default) == 0x0001C0, "Member 'W_SoldierPreview_C_ExecuteUbergraph_W_SoldierPreview::K2Node_Select_Default' has a wrong offset!");
...
{
public:
	struct FEmoteAnimationData                    EmoteAnimationData;                                // 0x0000(0x00F8)(BlueprintVisible, BlueprintReadOnly, Parm)
};
...
static_assert(sizeof(W_SoldierPreview_C_SetEmoteAnimation) == 0x0000F8, "Wrong size on W_SoldierPreview_C_SetEmoteAnimation");
static_assert(offsetof(W_SoldierPreview_C_SetEmoteAnimation, EmoteAnimationData) == 0x000000, "Member 'W_SoldierPreview_C_SetEmoteAnimation::EmoteAnimationData' has a wrong offset!");
