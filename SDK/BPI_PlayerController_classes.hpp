...
class IBPI_PlayerController_C final
{
public:
...
static_assert(alignof(IBPI_PlayerController_C) == 0x000001, "Wrong alignment on IBPI_PlayerController_C");
static_assert(sizeof(IBPI_PlayerController_C) == 0x000001, "Wrong size on IBPI_PlayerController_C");
