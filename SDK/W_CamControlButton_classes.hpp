...
public:
	...
	TMulticastInlineDelegate<void(bool Active, class ABP_ControlledCamera_C* Cam)> Cam_State_Changed; // 0x0298(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
