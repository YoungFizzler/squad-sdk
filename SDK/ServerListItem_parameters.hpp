...
public:
	...
	class UMainMenuScreen_C*                      CallFunc_GetMainMenuRef_REF_MainMenu;              // 0x0020(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_Toggle_Favourite_Valid;                   // 0x00D0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_Toggle_Favourite_Favourite;               // 0x00D1(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(sizeof(ServerListItem_C_ExecuteUbergraph_ServerListItem) == 0x0000D8, "Wrong size on ServerListItem_C_ExecuteUbergraph_ServerListItem");
...
static_assert(offsetof(ServerListItem_C_ExecuteUbergraph_ServerListItem, CallFunc_K2_SetTimerDelegate_ReturnValue) == 0x000018, "Member 'ServerListItem_C_ExecuteUbergraph_ServerListItem::CallFunc_K2_SetTimerDelegate_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerListItem_C_ExecuteUbergraph_ServerListItem, CallFunc_GetMainMenuRef_REF_MainMenu) == 0x000020, "Member 'ServerListItem_C_ExecuteUbergraph_ServerListItem::CallFunc_GetMainMenuRef_REF_MainMenu' has a wrong offset!");
static_assert(offsetof(ServerListItem_C_ExecuteUbergraph_ServerListItem, K2Node_Event_MyGeometry) == 0x000028, "Member 'ServerListItem_C_ExecuteUbergraph_ServerListItem::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(ServerListItem_C_ExecuteUbergraph_ServerListItem, K2Node_Event_MouseEvent) == 0x000060, "Member 'ServerListItem_C_ExecuteUbergraph_ServerListItem::K2Node_Event_MouseEvent' has a wrong offset!");
static_assert(offsetof(ServerListItem_C_ExecuteUbergraph_ServerListItem, CallFunc_Toggle_Favourite_Valid) == 0x0000D0, "Member 'ServerListItem_C_ExecuteUbergraph_ServerListItem::CallFunc_Toggle_Favourite_Valid' has a wrong offset!");
static_assert(offsetof(ServerListItem_C_ExecuteUbergraph_ServerListItem, CallFunc_Toggle_Favourite_Favourite) == 0x0000D1, "Member 'ServerListItem_C_ExecuteUbergraph_ServerListItem::CallFunc_Toggle_Favourite_Favourite' has a wrong offset!");
...
{
public:
	bool                                          Is_Whitelisted_0;                                  // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
static_assert(offsetof(ServerListItem_C_Is_Whitelisted, Is_Whitelisted_0) == 0x000000, "Member 'ServerListItem_C_Is_Whitelisted::Is_Whitelisted_0' has a wrong offset!");
