...
public:
	...
	TMulticastInlineDelegate<void()>              CloseWindow;                                       // 0x0328(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	int32                                         CurrentLayerChoiceIndex;                           // 0x0340(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_344[0x4];                                      // 0x0344(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<ESQLayerSpecialTag, class FText>         LayerSpecialTagsTranslation;                       // 0x0348(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UUMG_VoteLayer_C*                       VoteLayerRef;                                      // 0x0398(0x0008)(Edit, BlueprintVisible, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMG_VoteItem_C*                        AssignedChoiceWidget;                              // 0x03A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         OptionsCount;                                      // 0x03A8(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3AC[0x4];                                      // 0x03AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FText>                           FlagsTexts;                                        // 0x03B0(0x0010)(Edit, BlueprintVisible, DisableEditOnInstance)
	bool                                          SingleMode;                                        // 0x03C0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                         Pad_3C1[0x7];                                      // 0x03C1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FString, class UUMG_FactionNameLine_C*> DisplayedUnits;                               // 0x03C8(0x0050)(Edit, BlueprintVisible, DisableEditOnInstance, ContainsInstancedReference)
...
public:
	...
	void FillFromLayer(class UBP_SQLayer_C* Layer, class USQVoteSessionClient* Session, class FName LayerID, bool SingleMode_0);
	void GetAllAvailableFactions(class UBP_SQLayer_C* Layer, TMap<class USQFaction*, uint8>* ID);
	void FillAvailableFactionSetups(class UBP_SQLayer_C* Layer);
	void AddFactionSetup(TSoftObjectPtr<class UObject> FactionSetup, bool WithIcons, bool AttackTeam);
...
static_assert(sizeof(UUMG_LayerVoteDetails_C) == 0x000418, "Wrong size on UUMG_LayerVoteDetails_C");
...
static_assert(offsetof(UUMG_LayerVoteDetails_C, CurrentLayerChoiceIndex) == 0x000340, "Member 'UUMG_LayerVoteDetails_C::CurrentLayerChoiceIndex' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, LayerSpecialTagsTranslation) == 0x000348, "Member 'UUMG_LayerVoteDetails_C::LayerSpecialTagsTranslation' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, VoteLayerRef) == 0x000398, "Member 'UUMG_LayerVoteDetails_C::VoteLayerRef' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, AssignedChoiceWidget) == 0x0003A0, "Member 'UUMG_LayerVoteDetails_C::AssignedChoiceWidget' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, OptionsCount) == 0x0003A8, "Member 'UUMG_LayerVoteDetails_C::OptionsCount' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, FlagsTexts) == 0x0003B0, "Member 'UUMG_LayerVoteDetails_C::FlagsTexts' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, SingleMode) == 0x0003C0, "Member 'UUMG_LayerVoteDetails_C::SingleMode' has a wrong offset!");
static_assert(offsetof(UUMG_LayerVoteDetails_C, DisplayedUnits) == 0x0003C8, "Member 'UUMG_LayerVoteDetails_C::DisplayedUnits' has a wrong offset!");
