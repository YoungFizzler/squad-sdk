...
public:
	...
	class USortableColumnButton_C*                SortGameMode_ServerBrowserWindow_C;                // 0x0330(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	class USortableColumnButton_C*                SortNumPlayers_ServerBrowserWindow_C;              // 0x0348(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class USortableColumnButton_C*                SortPing_ServerBrowserWindow_C;                    // 0x0350(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class USortableColumnButton_C*                SortServerName_ServerBrowserWindow_C;              // 0x0358(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	...
	TMulticastInlineDelegate<void()>              Found_Sessions;                                    // 0x03E0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class USQSessionInfo*                         CurrentSession;                                    // 0x0408(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UPlayFabJsonObject*                     LastJsonAnalitics;                                 // 0x0410(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CanUpdateServerList;                               // 0x0418(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	bool                                          RequestedUpdateServerList;                         // 0x0419(0x0001)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
...
public:
	...
	void OnFailure();
	void OnUpdateSession(const TArray<struct FBlueprintSessionResult>& Results_0);
	void OnSuccess(const TArray<struct FBlueprintSessionResult>& Results_0);
	...
	void GetServerIndex(int32 PingMs, int32* Index_0);
	...
	void Reset_Search();
	void Add_unique_sessions(TArray<struct FBlueprintSessionResult>& Results_0);
	...
	void SetSelectedServer(class UServerListItem_C* SelectedServerItem_0);
	void GetMainMenuRef(class UMainMenuScreen_C** REF_MainMenu_0);
...
static_assert(sizeof(UServerBrowserWindow_C) == 0x000420, "Wrong size on UServerBrowserWindow_C");
...
static_assert(offsetof(UServerBrowserWindow_C, SortGameMode_ServerBrowserWindow_C) == 0x000330, "Member 'UServerBrowserWindow_C::SortGameMode_ServerBrowserWindow_C' has a wrong offset!");
...
static_assert(offsetof(UServerBrowserWindow_C, SortNumPlayers_ServerBrowserWindow_C) == 0x000348, "Member 'UServerBrowserWindow_C::SortNumPlayers_ServerBrowserWindow_C' has a wrong offset!");
static_assert(offsetof(UServerBrowserWindow_C, SortPing_ServerBrowserWindow_C) == 0x000350, "Member 'UServerBrowserWindow_C::SortPing_ServerBrowserWindow_C' has a wrong offset!");
static_assert(offsetof(UServerBrowserWindow_C, SortServerName_ServerBrowserWindow_C) == 0x000358, "Member 'UServerBrowserWindow_C::SortServerName_ServerBrowserWindow_C' has a wrong offset!");
...
static_assert(offsetof(UServerBrowserWindow_C, CurrentSession) == 0x000408, "Member 'UServerBrowserWindow_C::CurrentSession' has a wrong offset!");
static_assert(offsetof(UServerBrowserWindow_C, LastJsonAnalitics) == 0x000410, "Member 'UServerBrowserWindow_C::LastJsonAnalitics' has a wrong offset!");
static_assert(offsetof(UServerBrowserWindow_C, CanUpdateServerList) == 0x000418, "Member 'UServerBrowserWindow_C::CanUpdateServerList' has a wrong offset!");
static_assert(offsetof(UServerBrowserWindow_C, RequestedUpdateServerList) == 0x000419, "Member 'UServerBrowserWindow_C::RequestedUpdateServerList' has a wrong offset!");
