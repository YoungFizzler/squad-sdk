...
void IIDeployableEvents_C::OnServerValidatedItemPlacement(class ASQDeployableItem* Deployable)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("IDeployableEvents_C", "OnServerValidatedItemPlacement");
...
void IIDeployableEvents_C::OnClientInvalidatedItemPlacement()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("IDeployableEvents_C", "OnClientInvalidatedItemPlacement");
