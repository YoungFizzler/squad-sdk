...
void USortableColumnButton_C::Set_Selected(bool bSelected_0)
{
	static class UFunction* Func = nullptr;
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// ESQSortStates                           SortState_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                                    bSelected_0                                            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor)

void USortableColumnButton_C::Set_Sort_State(ESQSortStates SortState_0, bool bSelected_0)
{
	static class UFunction* Func = nullptr;
