...
class IBazaarOwnershipInterface final
{
public:
...
static_assert(alignof(IBazaarOwnershipInterface) == 0x000001, "Wrong alignment on IBazaarOwnershipInterface");
static_assert(sizeof(IBazaarOwnershipInterface) == 0x000001, "Wrong size on IBazaarOwnershipInterface");

// Class ODKBazaar.BazaarStoreInterface
// 0x0000 (0x0000 - 0x0000)
class IBazaarStoreInterface final
{
public:
...
static_assert(alignof(IBazaarStoreInterface) == 0x000001, "Wrong alignment on IBazaarStoreInterface");
static_assert(sizeof(IBazaarStoreInterface) == 0x000001, "Wrong size on IBazaarStoreInterface");
