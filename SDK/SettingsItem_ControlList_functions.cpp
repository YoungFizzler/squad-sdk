...
// Parameters:
// const class UControlsWindow_C*          ControlsWindow_0                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// const class FText&                      FriendlyName_0                                         (BlueprintVisible, BlueprintReadOnly, Parm)

void USettingsItem_ControlList_C::Init(const class UControlsWindow_C* ControlsWindow_0, class FName ActionName_0, const class FText& FriendlyName_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ControlsWindow_0 = ControlsWindow_0;
