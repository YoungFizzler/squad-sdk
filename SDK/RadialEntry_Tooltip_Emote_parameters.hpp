...
{
public:
	class FText                                   details_0;                                         // 0x0000(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
...
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, details_0) == 0x000000, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::details_0' has a wrong offset!");
...
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, CallFunc_GetActionKeyName_ReturnValue) == 0x000050, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::CallFunc_GetActionKeyName_ReturnValue' has a wrong offset!");
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, CallFunc_NotEqual_NameName_ReturnValue) == 0x000051, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::CallFunc_NotEqual_NameName_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, CallFunc_GetActionKeyName_ReturnValue_1) == 0x00005C, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::CallFunc_GetActionKeyName_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, CallFunc_NotEqual_NameName_ReturnValue_1) == 0x00005D, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::CallFunc_NotEqual_NameName_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, CallFunc_GetActionKeyName_ReturnValue_2) == 0x000068, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::CallFunc_GetActionKeyName_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(RadialEntry_Tooltip_Emote_C_UpdateDetails, CallFunc_NotEqual_NameName_ReturnValue_2) == 0x000069, "Member 'RadialEntry_Tooltip_Emote_C_UpdateDetails::CallFunc_NotEqual_NameName_ReturnValue_2' has a wrong offset!");
