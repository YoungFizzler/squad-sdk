...
// Parameters:
// const class FText&                      ToastText_0                                            (BlueprintVisible, BlueprintReadOnly, Parm)

void UBP_SQToastWidget_C::ToastTextUpdated_Event(const class FText& ToastText_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.ToastText_0 = std::move(ToastText_0);
