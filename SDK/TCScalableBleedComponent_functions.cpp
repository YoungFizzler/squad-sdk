...
// Parameters:
// TArray<class ATC_HexZone_C*>&           All_TC_Zones_0                                         (BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)

void UTCScalableBleedComponent_C::Initialise_TC_Bleed_Component(TArray<class ATC_HexZone_C*>& All_TC_Zones_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.All_TC_Zones_0 = std::move(All_TC_Zones_0);

	UObject::ProcessEvent(Func, &Parms);

	All_TC_Zones_0 = std::move(Parms.All_TC_Zones_0);
}
