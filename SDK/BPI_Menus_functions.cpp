...
void IBPI_Menus_C::Open_UI_Element(class USQCoreStateMapComponent* Map_Component, bool* Success)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Menus_C", "Open UI Element");
...
void IBPI_Menus_C::Close_UI_Element(bool* Success)
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Menus_C", "Close UI Element");
...
void IBPI_Menus_C::Key_Action()
{
	...
	if (Func == nullptr)
		Func = AsUObject()->Class->GetFunction("BPI_Menus_C", "Key Action");
