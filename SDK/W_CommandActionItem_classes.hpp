...
public:
	...
	TMulticastInlineDelegate<void()>              Clicked;                                           // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class UW_Command_ActionControl_C* Widget)> Created_Control_Widget; // 0x0358(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class APlayerState*                           RequestMarkerOwner;                                // 0x0370(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
...
static_assert(sizeof(UW_CommandActionItem_C) == 0x000378, "Wrong size on UW_CommandActionItem_C");
...
static_assert(offsetof(UW_CommandActionItem_C, Name_0) == 0x000280, "Member 'UW_CommandActionItem_C::Name_0' has a wrong offset!");
...
static_assert(offsetof(UW_CommandActionItem_C, RequestMarkerOwner) == 0x000370, "Member 'UW_CommandActionItem_C::RequestMarkerOwner' has a wrong offset!");
