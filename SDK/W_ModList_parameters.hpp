...
static_assert(offsetof(W_ModList_C_Init, SessionInfo_0) == 0x000000, "Member 'W_ModList_C_Init::SessionInfo_0' has a wrong offset!");
...
static_assert(offsetof(W_ModList_C_Is_Whitelisted, Is_Whitelisted_0) == 0x000000, "Member 'W_ModList_C_Is_Whitelisted::Is_Whitelisted_0' has a wrong offset!");
