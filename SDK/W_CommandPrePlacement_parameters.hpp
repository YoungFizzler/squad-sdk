...
{
public:
	class UClass*                                 SQAction_0;                                        // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(W_CommandPrePlacement_C_Set_Action, SQAction_0) == 0x000000, "Member 'W_CommandPrePlacement_C_Set_Action::SQAction_0' has a wrong offset!");
