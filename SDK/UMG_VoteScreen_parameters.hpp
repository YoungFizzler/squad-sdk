...
public:
	...
	bool                                          CallFunc_HasTimedOut_ReturnValue;                  // 0x0062(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          CallFunc_NotEqual_IntInt_ReturnValue;              // 0x006A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class USQVoteSessionClient*                   K2Node_Event_VoteSession_2;                        // 0x00A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_VotePossible;                         // 0x00B0(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USQVoteSessionClient*                   K2Node_Event_VoteSession_1;                        // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         K2Node_Event_PlayerCurrentVoteCount;               // 0x00C0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESQVoteType                                   CallFunc_GetVoteType_OutVoteType;                  // 0x00C4(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsRegenerationChoicePossible_ReturnValue; // 0x00C5(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_C6[0x2];                                       // 0x00C6(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IBPI_VoteScreen_C>     CallFunc_UpdateActivations_ActivatedScreen;        // 0x00C8(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESQVoteType                                   CallFunc_GetVoteType_OutVoteType_1;                // 0x00D8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_D9[0x7];                                       // 0x00D9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class USQVoteSessionClient*                   K2Node_Event_VoteSession;                          // 0x00E0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FSQChoice                              K2Node_Event_Winner;                               // 0x00E8(0x0018)(NoDestructor)
	ESQVoteType                                   CallFunc_GetVoteType_OutVoteType_2;                // 0x0100(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_101[0x7];                                      // 0x0101(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IBPI_VoteScreen_C>     CallFunc_UpdateActivations_ActivatedScreen_1;      // 0x0108(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	class UUMGSequencePlayer*                     CallFunc_PlayAnimationReverse_ReturnValue_2;       // 0x0118(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_Event_Activated;                            // 0x0120(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_121[0x7];                                      // 0x0121(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TScriptInterface<class IBPI_VoteScreen_C>     CallFunc_UpdateActivations_ActivatedScreen_2;      // 0x0128(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          Temp_bool_Variable_1;                              // 0x013A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	ESlateVisibility                              Temp_byte_Variable_2;                              // 0x013B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              Temp_byte_Variable_3;                              // 0x013C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsVisible_ReturnValue;                    // 0x013D(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsVisible_ReturnValue_1;                  // 0x013E(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          CallFunc_IsVisible_ReturnValue_2;                  // 0x013F(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FName                                   K2Node_ComponentBoundEvent_VoteID;                 // 0x0144(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	ESlateVisibility                              Temp_byte_Variable_4;                              // 0x014C(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_14D[0x3];                                      // 0x014D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FTimerHandle                           CallFunc_K2_SetTimer_ReturnValue;                  // 0x0150(0x0008)(NoDestructor, HasGetValueTypeHash)
	TDelegate<void(class FName LayerID)>          K2Node_CreateDelegate_OutputDelegate;              // 0x0158(0x0010)(ZeroConstructor, NoDestructor)
	TDelegate<void(class FName Faction)>          K2Node_CreateDelegate_OutputDelegate_1;            // 0x0168(0x0010)(ZeroConstructor, NoDestructor)
	class FName                                   K2Node_Event_ChoiceID;                             // 0x0178(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ASQGameState*                           CallFunc_GetSquadGameState_Return_Value;           // 0x0180(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FName                                   K2Node_ComponentBoundEvent_ChoiceId;               // 0x0190(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class ASQGameState*                           CallFunc_GetSquadGameState_Return_Value_1;         // 0x0198(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen) == 0x0001A8, "Wrong size on UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen");
...
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_PlayAnimationForward_ReturnValue) == 0x000018, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_PlayAnimationForward_ReturnValue_1) == 0x000020, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_PlayAnimationForward_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_PlayAnimationReverse_ReturnValue_1) == 0x000028, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_PlayAnimationReverse_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_PlayAnimationForward_ReturnValue_2) == 0x000030, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_PlayAnimationForward_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetPlayerController_ReturnValue) == 0x000038, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetHUD_ReturnValue) == 0x000040, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetHUD_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_DynamicCast_AsBP_HUD) == 0x000048, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_DynamicCast_AsBP_HUD' has a wrong offset!");
...
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetEndTime_ReturnValue_1) == 0x000054, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetEndTime_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_PlayAnimationForward_ReturnValue_3) == 0x000058, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_PlayAnimationForward_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_bool_Variable) == 0x000060, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_IsValid_ReturnValue) == 0x000061, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_HasTimedOut_ReturnValue) == 0x000062, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_HasTimedOut_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_CustomEvent_Index) == 0x000064, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_CustomEvent_Index' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_Array_Contains_ReturnValue) == 0x000068, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_IsValid_ReturnValue_1) == 0x000069, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_NotEqual_IntInt_ReturnValue) == 0x00006A, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_MyGeometry) == 0x00006C, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_InDeltaTime) == 0x0000A4, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_VoteSession_2) == 0x0000A8, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_VoteSession_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_VotePossible) == 0x0000B0, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_VotePossible' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_VoteSession_1) == 0x0000B8, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_VoteSession_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_PlayerCurrentVoteCount) == 0x0000C0, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_PlayerCurrentVoteCount' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetVoteType_OutVoteType) == 0x0000C4, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetVoteType_OutVoteType' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_IsRegenerationChoicePossible_ReturnValue) == 0x0000C5, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_IsRegenerationChoicePossible_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_UpdateActivations_ActivatedScreen) == 0x0000C8, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_UpdateActivations_ActivatedScreen' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetVoteType_OutVoteType_1) == 0x0000D8, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetVoteType_OutVoteType_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_VoteSession) == 0x0000E0, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_VoteSession' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_Winner) == 0x0000E8, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_Winner' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetVoteType_OutVoteType_2) == 0x000100, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetVoteType_OutVoteType_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_UpdateActivations_ActivatedScreen_1) == 0x000108, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_UpdateActivations_ActivatedScreen_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_PlayAnimationReverse_ReturnValue_2) == 0x000118, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_PlayAnimationReverse_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_Activated) == 0x000120, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_Activated' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_UpdateActivations_ActivatedScreen_2) == 0x000128, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_UpdateActivations_ActivatedScreen_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_byte_Variable) == 0x000138, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_byte_Variable_1) == 0x000139, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_bool_Variable_1) == 0x00013A, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_byte_Variable_2) == 0x00013B, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_byte_Variable_3) == 0x00013C, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_byte_Variable_3' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_IsVisible_ReturnValue) == 0x00013D, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_IsVisible_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_IsVisible_ReturnValue_1) == 0x00013E, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_IsVisible_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_IsVisible_ReturnValue_2) == 0x00013F, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_IsVisible_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_BooleanOR_ReturnValue) == 0x000140, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_BooleanOR_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_BooleanOR_ReturnValue_1) == 0x000141, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_BooleanOR_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_Not_PreBool_ReturnValue) == 0x000142, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_bool_Variable_2) == 0x000143, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_ComponentBoundEvent_VoteID) == 0x000144, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_ComponentBoundEvent_VoteID' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_byte_Variable_4) == 0x00014C, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_byte_Variable_4' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_K2_SetTimer_ReturnValue) == 0x000150, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_K2_SetTimer_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_CreateDelegate_OutputDelegate) == 0x000158, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_CreateDelegate_OutputDelegate_1) == 0x000168, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Event_ChoiceID) == 0x000178, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Event_ChoiceID' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetSquadGameState_Return_Value) == 0x000180, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetSquadGameState_Return_Value' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_BooleanAND_ReturnValue) == 0x000188, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Select_Default) == 0x000189, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Select_Default_1) == 0x00018A, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, Temp_byte_Variable_5) == 0x00018B, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::Temp_byte_Variable_5' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_Select_Default_2) == 0x00018C, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, K2Node_ComponentBoundEvent_ChoiceId) == 0x000190, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::K2Node_ComponentBoundEvent_ChoiceId' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_GetSquadGameState_Return_Value_1) == 0x000198, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_GetSquadGameState_Return_Value_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen, CallFunc_SelectInt_ReturnValue) == 0x0001A0, "Member 'UMG_VoteScreen_C_ExecuteUbergraph_UMG_VoteScreen::CallFunc_SelectInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UMG_VoteScreen_C_SwitchToScreen, Index_0) == 0x000000, "Member 'UMG_VoteScreen_C_SwitchToScreen::Index_0' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   NewTimerText;                                      // 0x0008(0x0018)(Edit, BlueprintVisible)
	...
	int32                                         CallFunc_GetRemainingTime_Minutes;                 // 0x0024(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         CallFunc_GetRemainingTime_Seconds;                 // 0x0028(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(UMG_VoteScreen_C_UpdateTimer) == 0x0000A0, "Wrong size on UMG_VoteScreen_C_UpdateTimer");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, Seconds) == 0x000000, "Member 'UMG_VoteScreen_C_UpdateTimer::Seconds' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, NewTimerText) == 0x000008, "Member 'UMG_VoteScreen_C_UpdateTimer::NewTimerText' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_NotEqual_IntInt_ReturnValue) == 0x000020, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_NotEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_IsValid_ReturnValue) == 0x000021, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000022, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_IsValid_ReturnValue_1) == 0x000023, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_GetRemainingTime_Minutes) == 0x000024, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_GetRemainingTime_Minutes' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_GetRemainingTime_Seconds) == 0x000028, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_GetRemainingTime_Seconds' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_Multiply_IntInt_ReturnValue) == 0x00002C, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_Multiply_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_Add_IntInt_ReturnValue) == 0x000030, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, K2Node_MakeStruct_FormatArgumentData) == 0x000038, "Member 'UMG_VoteScreen_C_UpdateTimer::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, K2Node_MakeArray_Array) == 0x000078, "Member 'UMG_VoteScreen_C_UpdateTimer::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_UpdateTimer, CallFunc_Format_ReturnValue) == 0x000088, "Member 'UMG_VoteScreen_C_UpdateTimer::CallFunc_Format_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(UMG_VoteScreen_C_TickCheck) == 0x000160, "Wrong size on UMG_VoteScreen_C_TickCheck");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_IsValid_ReturnValue) == 0x000000, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000001, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, K2Node_MakeStruct_FormatArgumentData) == 0x000018, "Member 'UMG_VoteScreen_C_TickCheck::K2Node_MakeStruct_FormatArgumentData' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_Conv_IntToText_ReturnValue) == 0x000058, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_Conv_IntToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, K2Node_MakeArray_Array) == 0x000070, "Member 'UMG_VoteScreen_C_TickCheck::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, K2Node_MakeStruct_FormatArgumentData_1) == 0x000080, "Member 'UMG_VoteScreen_C_TickCheck::K2Node_MakeStruct_FormatArgumentData_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_Format_ReturnValue) == 0x0000C0, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_Format_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_Greater_IntInt_ReturnValue) == 0x0000D8, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_Percent_IntInt_ReturnValue) == 0x0000DC, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_Percent_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_Conv_IntToText_ReturnValue_1) == 0x0000E0, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_Conv_IntToText_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, K2Node_MakeStruct_FormatArgumentData_2) == 0x0000F8, "Member 'UMG_VoteScreen_C_TickCheck::K2Node_MakeStruct_FormatArgumentData_2' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, K2Node_MakeArray_Array_1) == 0x000138, "Member 'UMG_VoteScreen_C_TickCheck::K2Node_MakeArray_Array_1' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_TickCheck, CallFunc_Format_ReturnValue_1) == 0x000148, "Member 'UMG_VoteScreen_C_TickCheck::CallFunc_Format_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(UMG_VoteScreen_C_UpdatePlayersCountText, Index_0) == 0x000000, "Member 'UMG_VoteScreen_C_UpdatePlayersCountText::Index_0' has a wrong offset!");
...
// Function UMG_VoteScreen.UMG_VoteScreen_C.SetOuterTimer
// 0x0010 (0x0010 - 0x0000)
struct UMG_VoteScreen_C_SetOuterTimer final
{
public:
	class UTextBlock*                             TextTop_0;                                         // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UTextBlock*                             TextTimer_0;                                       // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(UMG_VoteScreen_C_SetOuterTimer) == 0x000008, "Wrong alignment on UMG_VoteScreen_C_SetOuterTimer");
static_assert(sizeof(UMG_VoteScreen_C_SetOuterTimer) == 0x000010, "Wrong size on UMG_VoteScreen_C_SetOuterTimer");
static_assert(offsetof(UMG_VoteScreen_C_SetOuterTimer, TextTop_0) == 0x000000, "Member 'UMG_VoteScreen_C_SetOuterTimer::TextTop_0' has a wrong offset!");
static_assert(offsetof(UMG_VoteScreen_C_SetOuterTimer, TextTimer_0) == 0x000008, "Member 'UMG_VoteScreen_C_SetOuterTimer::TextTimer_0' has a wrong offset!");
