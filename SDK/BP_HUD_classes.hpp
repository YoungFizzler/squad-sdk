...
public:
	...
	TMulticastInlineDelegate<void(float Zoom_Amount)> Zoom_Updated;                                  // 0x0A20(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              Clear_Widgets;                                     // 0x0A78(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class UUMG_MenuBase_C* Menu)> Menu_Closed;                         // 0x0AA8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class UUMG_MenuBase_C* Menu)> Menu_Opened;                         // 0x0AB8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void()>              HUD_Can_Start;                                     // 0x0AC8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void()>              OnMapCoreChanged;                                  // 0x0AE0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	class UW_EndRoundMainScreen_C*                EndRoundScreen;                                    // 0x0B08(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UUMG_ScoreboardScreen_C*                ScoreboardScreen;                                  // 0x0B10(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	void Get_Interactor_Display_Name(class AActor* Actor, class FText* Name_0);
	...
	void CreateEndRoundScreen();
	void Get_Radial_Menu(class UBaseRadialMenu_C** Radial_Menu);
	void Get_Main_Menus(class UUMG_MenuBase_C** Deployment_0, class UUMG_MenuBase_C** Command_0, class UUMG_MenuBase_C** Roaming);
	...
	void Get_Scoreboard(class USQScoreboard** ScoreBoard_0);
	void Get_UI_Input_Stacks(TArray<struct FSQInputState>* Input_Stacks);
	void Get_Interactable_Widget(class USQInteractableWidgetList** Interact_Widget_0);
...
static_assert(sizeof(ABP_HUD_C) == 0x000B18, "Wrong size on ABP_HUD_C");
...
static_assert(offsetof(ABP_HUD_C, EndRoundScreen) == 0x000B08, "Member 'ABP_HUD_C::EndRoundScreen' has a wrong offset!");
static_assert(offsetof(ABP_HUD_C, ScoreboardScreen) == 0x000B10, "Member 'ABP_HUD_C::ScoreboardScreen' has a wrong offset!");
