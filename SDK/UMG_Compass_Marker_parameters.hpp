...
static_assert(offsetof(UMG_Compass_Marker_C_ChangeDisplayMode, bTopScreenView_0) == 0x000000, "Member 'UMG_Compass_Marker_C_ChangeDisplayMode::bTopScreenView_0' has a wrong offset!");
