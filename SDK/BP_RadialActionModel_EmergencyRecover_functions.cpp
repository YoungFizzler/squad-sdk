...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class USQRadialButton*                  Widget_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UBP_RadialActionModel_EmergencyRecover_C::Populate(class USQRadialButton* Widget_0, class UBaseRadialMenu_C* Menu, class UObject* Context)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class USQRadialButton*                  Widget_0                                               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class ASQVehicle*                       Vehicle_0                                              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_RadialActionModel_EmergencyRecover_C::Update_Button(class USQRadialButton* Widget_0, class ASQVehicle* Vehicle_0)
{
	static class UFunction* Func = nullptr;
...
void UBP_RadialActionModel_EmergencyRecover_C::Get_Correct_Recovery_Methods(class ASQVehicle* Vehicle_0, TSet<ESQVehicleRecoveryMethod>* RecoveryMethodsAvailable) const
{
	static class UFunction* Func = nullptr;
