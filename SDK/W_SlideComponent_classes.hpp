...
public:
	...
	TMulticastInlineDelegate<void()>              Slide_Opened;                                      // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void()>              Slide_Closed;                                      // 0x02D0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	class FText                                   Name_0;                                            // 0x02E0(0x0018)(Edit, BlueprintVisible)
...
static_assert(offsetof(UW_SlideComponent_C, Name_0) == 0x0002E0, "Member 'UW_SlideComponent_C::Name_0' has a wrong offset!");
