...
public:
	...
	TDelegate<void(bool bIsAscending, E_SortType Sort_Type)> K2Node_CreateDelegate_OutputDelegate;   // 0x003C(0x0010)(ZeroConstructor, NoDestructor)
	...
	TArray<struct FBlueprintSessionResult>        K2Node_Event_Results_1;                            // 0x0058(0x0010)(ConstParm, ReferenceParm)
	TArray<struct FBlueprintSessionResult>        K2Node_Event_Results;                              // 0x0068(0x0010)(ConstParm, ReferenceParm)
	class USQSessionInfo*                         K2Node_CustomEvent_Session;                        // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          K2Node_ComponentBoundEvent_bSelected;              // 0x0080(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_81[0x7];                                       // 0x0081(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UW_MainMenuButton_C*                    K2Node_ComponentBoundEvent_Button;                 // 0x0088(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FString                                 K2Node_CustomEvent_Type;                           // 0x0090(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 K2Node_CustomEvent_EventName;                      // 0x00A0(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	struct FBlueprintSessionResult                CallFunc_Array_Get_Item;                           // 0x00B8(0x0108)()
	class UServerListItem_C*                      CallFunc_AddNewServerWidget_Item;                  // 0x01C0(0x0008)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x01C8(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1C9[0x7];                                      // 0x01C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UPlayFabJsonObject*                     CallFunc_ConstructJsonObject_ReturnValue;          // 0x01D0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class USQSessionInfo*                         K2Node_CustomEvent_SessionInfo;                    // 0x01D8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class FString>                         CallFunc_GetSelectedTagsString_Out;                // 0x0200(0x0010)(ReferenceParm)
	TDelegate<void(class USQSessionInfo* Session)> K2Node_CreateDelegate_OutputDelegate_1;           // 0x0210(0x0010)(ZeroConstructor, NoDestructor)
	class USQGameUserSettings*                    CallFunc_GetSquadGameUserSettings_ReturnValue;     // 0x0220(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldApplyFilters_Apply;                 // 0x0228(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	bool                                          Temp_bool_IsClosed_Variable;                       // 0x0229(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                          Temp_bool_Has_Been_Initd_Variable;                 // 0x0230(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(sizeof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow) == 0x000250, "Wrong size on ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow");
...
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, Temp_int_Loop_Counter_Variable) == 0x000004, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_Add_IntInt_ReturnValue) == 0x000008, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_GetSquadPlayerController_Return_Value) == 0x000010, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_GetSquadPlayerController_Return_Value' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_Array_Length_ReturnValue) == 0x000018, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_Less_IntInt_ReturnValue) == 0x00001C, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_ComponentBoundEvent_Text) == 0x000020, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_ComponentBoundEvent_Text' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_ComponentBoundEvent_CommitMethod) == 0x000038, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_ComponentBoundEvent_CommitMethod' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_SwitchEnum_CmpSuccess) == 0x000039, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_CreateDelegate_OutputDelegate) == 0x00003C, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_Get_UI_Save_Data_UI_Save_Data) == 0x000050, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_Get_UI_Save_Data_UI_Save_Data' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_Event_Results_1) == 0x000058, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_Event_Results_1' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_Event_Results) == 0x000068, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_Event_Results' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_CustomEvent_Session) == 0x000078, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_CustomEvent_Session' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_ComponentBoundEvent_bSelected) == 0x000080, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_ComponentBoundEvent_bSelected' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_ComponentBoundEvent_Button) == 0x000088, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_CustomEvent_Type) == 0x000090, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_CustomEvent_Type' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_CustomEvent_EventName) == 0x0000A0, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_CustomEvent_EventName' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, Temp_int_Array_Index_Variable) == 0x0000B0, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_Array_Get_Item) == 0x0000B8, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_AddNewServerWidget_Item) == 0x0001C0, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_AddNewServerWidget_Item' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_IsValid_ReturnValue) == 0x0001C8, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_ConstructJsonObject_ReturnValue) == 0x0001D0, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_ConstructJsonObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_CustomEvent_SessionInfo) == 0x0001D8, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_CustomEvent_SessionInfo' has a wrong offset!");
...
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_MakeLiteralText_ReturnValue) == 0x0001E8, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_MakeLiteralText_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_GetSelectedTagsString_Out) == 0x000200, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_GetSelectedTagsString_Out' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_CreateDelegate_OutputDelegate_1) == 0x000210, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_CreateDelegate_OutputDelegate_1' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_GetSquadGameUserSettings_ReturnValue) == 0x000220, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_GetSquadGameUserSettings_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_ShouldApplyFilters_Apply) == 0x000228, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_ShouldApplyFilters_Apply' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, Temp_bool_IsClosed_Variable) == 0x000229, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::Temp_bool_IsClosed_Variable' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_Conv_IntToFloat_ReturnValue) == 0x00022C, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_Conv_IntToFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, Temp_bool_Has_Been_Initd_Variable) == 0x000230, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::Temp_bool_Has_Been_Initd_Variable' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, CallFunc_GetGameInstance_ReturnValue) == 0x000238, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::CallFunc_GetGameInstance_ReturnValue' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_DynamicCast_AsBP_Squad_Game_Instance) == 0x000240, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_DynamicCast_AsBP_Squad_Game_Instance' has a wrong offset!");
static_assert(offsetof(ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow, K2Node_DynamicCast_bSuccess) == 0x000248, "Member 'ServerBrowserWindow_C_ExecuteUbergraph_ServerBrowserWindow::K2Node_DynamicCast_bSuccess' has a wrong offset!");
...
static_assert(offsetof(ServerBrowserWindow_C_OnUpdateSession, Results_0) == 0x000000, "Member 'ServerBrowserWindow_C_OnUpdateSession::Results_0' has a wrong offset!");
...
static_assert(offsetof(ServerBrowserWindow_C_OnSuccess, Results_0) == 0x000000, "Member 'ServerBrowserWindow_C_OnSuccess::Results_0' has a wrong offset!");
...
static_assert(offsetof(ServerBrowserWindow_C_GetServerIndex, Index_0) == 0x000004, "Member 'ServerBrowserWindow_C_GetServerIndex::Index_0' has a wrong offset!");
...
{
public:
	TArray<struct FBlueprintSessionResult>        Results_0;                                         // 0x0000(0x0010)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
...
static_assert(offsetof(ServerBrowserWindow_C_Add_unique_sessions, Results_0) == 0x000000, "Member 'ServerBrowserWindow_C_Add_unique_sessions::Results_0' has a wrong offset!");
...
{
public:
	class UServerListItem_C*                      SelectedServerItem_0;                              // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ServerBrowserWindow_C_SetSelectedServer, SelectedServerItem_0) == 0x000000, "Member 'ServerBrowserWindow_C_SetSelectedServer::SelectedServerItem_0' has a wrong offset!");
...
{
public:
	class UMainMenuScreen_C*                      REF_MainMenu_0;                                    // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(ServerBrowserWindow_C_GetMainMenuRef, REF_MainMenu_0) == 0x000000, "Member 'ServerBrowserWindow_C_GetMainMenuRef::REF_MainMenu_0' has a wrong offset!");
