...
public:
	...
	TMulticastInlineDelegate<void(class AActor* ActorRef, class USQVehicleComponent* Component, float Amount, class UClass* Type)> ApplyDamageToSelected; // 0x02F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class AActor* Actor)> DestroySelectedActor;                        // 0x0308(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(class ASQSoldier* Soldier)> PossessSelected;                       // 0x0318(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
