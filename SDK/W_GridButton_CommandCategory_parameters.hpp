...
{
public:
	int32                                         Category_ID_0;                                     // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(W_GridButton_CommandCategory_C_Init_Actions, Category_ID_0) == 0x000000, "Member 'W_GridButton_CommandCategory_C_Init_Actions::Category_ID_0' has a wrong offset!");
