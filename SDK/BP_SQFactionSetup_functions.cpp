...
// TArray<struct FSQRoleGroupingStrategy>* RoleGroupingStrategies_0                               (Parm, OutParm)

void UBP_SQFactionSetup_C::TryGetRoleGroupingStrategies(bool* Success, TArray<struct FSQRoleGroupingStrategy>* RoleGroupingStrategies_0)
{
	...
	if (RoleGroupingStrategies_0 != nullptr)
		*RoleGroupingStrategies_0 = std::move(Parms.RoleGroupingStrategies_0);
}
...
// class UBP_SQFaction_C**                 OuterFaction_0                                         (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBP_SQFactionSetup_C::GetOuterFaction(bool* Out_Success, class UBP_SQFaction_C** OuterFaction_0) const
{
	static class UFunction* Func = nullptr;
	...
	if (OuterFaction_0 != nullptr)
		*OuterFaction_0 = Parms.OuterFaction_0;
}
...
// Parameters:
// const class USQFactionSetup*            OtherFaction                                           (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
