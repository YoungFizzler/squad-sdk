...
{
public:
	const class UControlsWindow_C*                ControlsWindow_0;                                  // 0x0000(0x0008)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                   FriendlyName_0;                                    // 0x0010(0x0018)(BlueprintVisible, BlueprintReadOnly, Parm)
...
static_assert(offsetof(SettingsItem_ControlList_C_Init, ControlsWindow_0) == 0x000000, "Member 'SettingsItem_ControlList_C_Init::ControlsWindow_0' has a wrong offset!");
static_assert(offsetof(SettingsItem_ControlList_C_Init, ActionName_0) == 0x000008, "Member 'SettingsItem_ControlList_C_Init::ActionName_0' has a wrong offset!");
static_assert(offsetof(SettingsItem_ControlList_C_Init, FriendlyName_0) == 0x000010, "Member 'SettingsItem_ControlList_C_Init::FriendlyName_0' has a wrong offset!");
