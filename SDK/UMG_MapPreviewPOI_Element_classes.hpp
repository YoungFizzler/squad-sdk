...
public:
	...
	TMulticastInlineDelegate<void(class UUMG_MapPreviewPOI_Element_C* POI, bool Hovered)> PoiHovered; // 0x02C0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
