...
{
public:
	class USQVoteSession*                         VoteSession_0;                                     // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(VoteScreenListItem_C_OnVoteEnded, VoteSession_0) == 0x000000, "Member 'VoteScreenListItem_C_OnVoteEnded::VoteSession_0' has a wrong offset!");
...
public:
	class USQVoteSession*                         VoteSession_0;                                     // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	int32                                         PlayerCurrentVotes_0;                              // 0x0008(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(VoteScreenListItem_C_OnVoteUpdated, VoteSession_0) == 0x000000, "Member 'VoteScreenListItem_C_OnVoteUpdated::VoteSession_0' has a wrong offset!");
static_assert(offsetof(VoteScreenListItem_C_OnVoteUpdated, PlayerCurrentVotes_0) == 0x000008, "Member 'VoteScreenListItem_C_OnVoteUpdated::PlayerCurrentVotes_0' has a wrong offset!");
