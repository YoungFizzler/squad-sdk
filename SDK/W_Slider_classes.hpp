...
public:
	...
	TMulticastInlineDelegate<void(float NewParam)> OnValueChanged;                                   // 0x0340(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	TMulticastInlineDelegate<void(float Value)>   OnCaptureEnd;                                      // 0x0350(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void BndEvt__BaseSlider_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature(float Value_0);
	void Construct();
	...
	void GetTextColor(float Value_0, struct FLinearColor* TextColor_0, class FText* WarningText);
	void UpdateStyle();
