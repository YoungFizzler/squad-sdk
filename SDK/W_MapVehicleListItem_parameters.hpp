...
{
public:
	bool                                          HasTimer_0;                                        // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
...
static_assert(offsetof(W_MapVehicleListItem_C_HasTimer, HasTimer_0) == 0x000000, "Member 'W_MapVehicleListItem_C_HasTimer::HasTimer_0' has a wrong offset!");
