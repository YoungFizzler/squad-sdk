...
public:
	...
	TMulticastInlineDelegate<void(int32 ButtonNumber, class USettingsItem_GraphicsToggle_C* ToggleItem)> OnButtonClick; // 0x02F8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
