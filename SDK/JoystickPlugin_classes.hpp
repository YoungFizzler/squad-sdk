...
class IJoystickInterface final
{
public:
...
static_assert(alignof(IJoystickInterface) == 0x000001, "Wrong alignment on IJoystickInterface");
static_assert(sizeof(IJoystickInterface) == 0x000001, "Wrong size on IJoystickInterface");
