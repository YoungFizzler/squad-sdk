...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class USQPawnInventoryComponent*        InventoryComponent_0                                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void URadialCenterRearmButton_C::SetInventoryComponent(class USQPawnInventoryComponent* InventoryComponent_0)
{
	static class UFunction* Func = nullptr;
	...
	Parms.InventoryComponent_0 = InventoryComponent_0;
...
// Parameters:
// const class ASQEquipableItem*&          WeaponToRemove                                         (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
