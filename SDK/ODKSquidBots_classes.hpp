...
static_assert(alignof(IODKSeededRandom) == 0x000001, "Wrong alignment on IODKSeededRandom");
static_assert(sizeof(IODKSeededRandom) == 0x000001, "Wrong size on IODKSeededRandom");
...
// 0x0000 (0x0000 - 0x0000)
class IODKSuppressionNotificationInterface final
{
public:
...
static_assert(alignof(IODKSuppressionNotificationInterface) == 0x000001, "Wrong alignment on IODKSuppressionNotificationInterface");
static_assert(sizeof(IODKSuppressionNotificationInterface) == 0x000001, "Wrong size on IODKSuppressionNotificationInterface");
