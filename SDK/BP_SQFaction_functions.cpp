...
bool UBP_SQFaction_C::TryGetMediumSizeFlag(TSoftObjectPtr<class UTexture2D>* OutTexture) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("BP_SQFaction_C", "TryGetMediumSizeFlag");

	Params::BP_SQFaction_C_TryGetMediumSizeFlag Parms{};
