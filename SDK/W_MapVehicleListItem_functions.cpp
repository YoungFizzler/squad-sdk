...
// Parameters:
// const struct FSQAvailabilityState_Vehicle&State                                                  (BlueprintVisible, BlueprintReadOnly, Parm, ContainsInstancedReference)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FDateTime&                 NextAvailability                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
// Parameters:
// const struct FDataTableRowHandle&       Reason                                                 (BlueprintVisible, BlueprintReadOnly, Parm, NoDestructor)
...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// bool*                                   HasTimer_0                                             (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)

void UW_MapVehicleListItem_C::HasTimer(bool* HasTimer_0)
{
	static class UFunction* Func = nullptr;
	...
	if (HasTimer_0 != nullptr)
		*HasTimer_0 = Parms.HasTimer_0;
}
...
// const struct FSQAvailabilityState&      In_State                                               (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
