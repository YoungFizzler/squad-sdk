...
{
public:
	class URadialCenterRearmButton_C*             CenterWidget_0;                                    // 0x0000(0x0008)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(RadialRearmWidget_C_SetCenterWidget, CenterWidget_0) == 0x000000, "Member 'RadialRearmWidget_C_SetCenterWidget::CenterWidget_0' has a wrong offset!");
