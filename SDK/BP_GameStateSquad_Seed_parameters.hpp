...
// Function BP_GameStateSquad_Seed.BP_GameStateSquad_Seed_C.ExecuteUbergraph_BP_GameStateSquad_Seed
// 0x001C (0x001C - 0x0000)
struct BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed final
{
public:
	...
	TDelegate<void(int32 SeedTargetPlayerCount)>  K2Node_CreateDelegate_OutputDelegate;              // 0x0008(0x0010)(ZeroConstructor, NoDestructor)
	int32                                         K2Node_CustomEvent_SeedTargetPlayerCount;          // 0x0018(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed) == 0x000004, "Wrong alignment on BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed");
static_assert(sizeof(BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed) == 0x00001C, "Wrong size on BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed");
static_assert(offsetof(BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed, EntryPoint) == 0x000000, "Member 'BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed::EntryPoint' has a wrong offset!");
static_assert(offsetof(BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed, CallFunc_IsServer_ReturnValue) == 0x000004, "Member 'BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed::CallFunc_IsServer_ReturnValue' has a wrong offset!");
static_assert(offsetof(BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed, K2Node_CreateDelegate_OutputDelegate) == 0x000008, "Member 'BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
static_assert(offsetof(BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed, K2Node_CustomEvent_SeedTargetPlayerCount) == 0x000018, "Member 'BP_GameStateSquad_Seed_C_ExecuteUbergraph_BP_GameStateSquad_Seed::K2Node_CustomEvent_SeedTargetPlayerCount' has a wrong offset!");

// Function BP_GameStateSquad_Seed.BP_GameStateSquad_Seed_C.OnSetSeedTargetPlayerCount
// 0x0004 (0x0004 - 0x0000)
struct BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount final
{
public:
	int32                                         SeedTargetPlayerCount_0;                           // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount) == 0x000004, "Wrong alignment on BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount");
static_assert(sizeof(BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount) == 0x000004, "Wrong size on BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount");
static_assert(offsetof(BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount, SeedTargetPlayerCount_0) == 0x000000, "Member 'BP_GameStateSquad_Seed_C_OnSetSeedTargetPlayerCount::SeedTargetPlayerCount_0' has a wrong offset!");
