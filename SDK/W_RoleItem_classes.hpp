...
public:
	...
	TMulticastInlineDelegate<void(class USQRoleSettings* Role)> Role_Selected;                       // 0x02B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
	...
	TMulticastInlineDelegate<void(class USQRoleSettings* Role, bool Hovered, class UW_RoleItem_C* Button_Reference, bool bSubRole)> Role_Hovered; // 0x03A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
