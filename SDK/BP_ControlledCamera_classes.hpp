...
public:
	...
	TMulticastInlineDelegate<void(class UW_CamControlButton_C* Cam_Button)> Created_Button;          // 0x0278(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
