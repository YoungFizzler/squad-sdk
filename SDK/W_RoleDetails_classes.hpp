...
public:
	...
	TMulticastInlineDelegate<void(class USQRoleSettings* Role_Reference)> OnSubRoleSelected;         // 0x03F0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
...
public:
	...
	void Clear_All();
	void Get_Item_Info(const struct FSQInventoryData& Primary_Data_0, int32* Item_Count);
