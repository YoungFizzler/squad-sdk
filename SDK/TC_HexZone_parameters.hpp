...
{
public:
	int32                                         Hex_Num_0;                                         // 0x0000(0x0004)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_4[0x4];                                        // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(TC_HexZone_C_Set_ID, Hex_Num_0) == 0x000000, "Member 'TC_HexZone_C_Set_ID::Hex_Num_0' has a wrong offset!");
...
{
public:
	bool                                          Protected_0;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                         Pad_1[0x3];                                        // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         Temp_int_Array_Index_Variable;                     // 0x0004(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(TC_HexZone_C_Get_Protected_By_Neighbours, Protected_0) == 0x000000, "Member 'TC_HexZone_C_Get_Protected_By_Neighbours::Protected_0' has a wrong offset!");
