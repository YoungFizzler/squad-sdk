...
void UW_Slider_C::BndEvt__BaseSlider_K2Node_ComponentBoundEvent_0_OnFloatValueChangedEvent__DelegateSignature(float Value_0)
{
	static class UFunction* Func = nullptr;
...
void UW_Slider_C::SetValue(float Value_0)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// float                                   Value_0                                                (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FLinearColor*                    TextColor_0                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// class FText*                            WarningText                                            (Parm, OutParm)

void UW_Slider_C::GetTextColor(float Value_0, struct FLinearColor* TextColor_0, class FText* WarningText)
{
	static class UFunction* Func = nullptr;
	...
	if (TextColor_0 != nullptr)
		*TextColor_0 = std::move(Parms.TextColor_0);
...
// (Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSliderStyle&              WidgetStyle                                            (BlueprintVisible, BlueprintReadOnly, Parm)
