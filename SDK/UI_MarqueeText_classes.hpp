...
public:
	...
	void UpdateFont(const struct FSlateFontInfo& InFontInfo, ETextJustify StartJustification_0, const struct FSlateColor& TextColor);
	void SetStartText(const class FString& NewText);
	void ResetText();
	void MarqueeIteration();

	void GetMainButton(class UButton** DetectionButton_0) const;
